...
} elseif ($_instance->childHasBeenRendered('HvhzBiw')) {
    $componentId = $_instance->getRenderedChildComponentId('HvhzBiw');
    $componentTag = $_instance->getRenderedChildComponentTagName('HvhzBiw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HvhzBiw');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('HvhzBiw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:143px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
...
<!-- Livewire Component wire-end:5YXRNmqHBfZbzZBjZIgX -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/4f82411e816473c6f1ac5db4eec00c7c828a88aa.blade.php ENDPATH**/ ?>