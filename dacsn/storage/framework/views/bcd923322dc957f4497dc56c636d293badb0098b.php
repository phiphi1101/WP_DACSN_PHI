...
} elseif ($_instance->childHasBeenRendered('i4zMP0M')) {
    $componentId = $_instance->getRenderedChildComponentId('i4zMP0M');
    $componentTag = $_instance->getRenderedChildComponentTagName('i4zMP0M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('i4zMP0M');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('i4zMP0M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:142px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="GEqU1mZVBIdjI3EyJtln" wire:initial-data='{"fingerprint":{"id":"GEqU1mZVBIdjI3EyJtln","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"0fa8d194","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"0de72181691d35f766daaf64df50aa5df8b143b0dc6b439761431ec3f18c23f4"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:v6q36KOKXdwfb4lo2de5 -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/632821c80d5e02843af647b7f2570b09d0d85424.blade.php ENDPATH**/ ?>