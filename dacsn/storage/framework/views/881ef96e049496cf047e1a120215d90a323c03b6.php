...
} elseif ($_instance->childHasBeenRendered('IsjDndt')) {
    $componentId = $_instance->getRenderedChildComponentId('IsjDndt');
    $componentTag = $_instance->getRenderedChildComponentTagName('IsjDndt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IsjDndt');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('IsjDndt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="O4qfaGLPRH36DxrxfcBv" wire:initial-data='{"fingerprint":{"id":"O4qfaGLPRH36DxrxfcBv","name":"admin-pages-list","locale":"vi_VN","path":"admin\/page","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/page?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"9276392e","data":{"model":"MicroweberPackages\\Page\\Models\\Page","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"38bb3dbde59006857df1ef6bf99afbecd840b38de7022b4ad723d63a30ae0ebb"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:nSfJRo0ZvHbn3bNu1jyZ -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/e91790139458c89462f6fe66ee50b4e28b8ae9d3.blade.php ENDPATH**/ ?>