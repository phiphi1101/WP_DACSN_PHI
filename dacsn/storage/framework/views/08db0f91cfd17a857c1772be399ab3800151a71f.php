...
} elseif ($_instance->childHasBeenRendered('sbRafGj')) {
    $componentId = $_instance->getRenderedChildComponentId('sbRafGj');
    $componentTag = $_instance->getRenderedChildComponentTagName('sbRafGj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sbRafGj');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('sbRafGj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/ed53a375fff63c97acd9e2875642d37c24b79f5c.blade.php ENDPATH**/ ?>