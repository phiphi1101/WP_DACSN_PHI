...
} elseif ($_instance->childHasBeenRendered('dle4gdk')) {
    $componentId = $_instance->getRenderedChildComponentId('dle4gdk');
    $componentTag = $_instance->getRenderedChildComponentTagName('dle4gdk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dle4gdk');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('dle4gdk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="M2XMhJmJrOt15gl0BEuB" wire:initial-data='{"fingerprint":{"id":"M2XMhJmJrOt15gl0BEuB","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"3f2fbeaa","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"c3a2b9f2f064dd416ef690aa1e55f9941370333233a73241ea741cede0feb7d1"}}' class="card style-1 mb-3">
...
<script>
    ...
    <select class="form-select form-select-sm" wire:model="paginate">
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/539?saved" class="rounded-full">
    </div>
...
<!-- Livewire Component wire-end:6MKyV6PaZ3VlKlg8KU6r -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/ebd74eeff8dec83260939afa086c3bf917e114c4.blade.php ENDPATH**/ ?>