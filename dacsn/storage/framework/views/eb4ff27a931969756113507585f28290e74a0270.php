...
<script id="mw-api-js" src="http://localhost/dacsn/apijs_combined?mwv=1.3.2"></script>
...
} elseif ($_instance->childHasBeenRendered('HZ24PNO')) {
    $componentId = $_instance->getRenderedChildComponentId('HZ24PNO');
    $componentTag = $_instance->getRenderedChildComponentTagName('HZ24PNO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HZ24PNO');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('HZ24PNO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
    ...
    <div class="main container my-3">
        <aside>
            ...
            <ul class="nav flex-column" id="mw-admin-main-navigation">
                <li class="nav-item">
                    <a href="http://localhost/dacsn/admin/" class="nav-link  active ">
...
<p style="font-size: 24px; color: #555555;"> Chào mừng đến với Microweber 1.3.2</p>Sử dụng Microweber để xây dựng trang web, cửa hàng trực tuyến hoặc blog của bạn.<p style="font-size: 13px; color: #999999; line-height: 1.6; margin-bottom: 5px;">  </p>Tạo và chỉnh sửa nội dung, bán hàng trực tuyến, quản lý đơn đặt hàng và khách hàng.<p style="font-size: 13px; color: #999999; line-height: 1.6; margin-bottom:30px;"> </p><div type="site_stats/admin" class="mw-lazy-load-module" id="site_stats_admin"></div><div type="comments/dashboard_recent_comments" class="mw-lazy-load-module" id="admin-dashboard-recent-comments" no_paging="true"></div><div type="shop/orders/dashboard_recent_orders" class="mw-lazy-load-module" id="site_stats_dashboard_recent_orders"></div><div type="contact_form/dashboard_recent_messages" class="mw-lazy-load-module" id="admin-dashboard-contact-form"></div>
<div class="card style-1">
    <div class="card-header">
        <h5><i class="mdi mdi-link text-primary mr-3"></i> <strong>đường dẫn nhanh</strong></h5>
    </div>

    <div class="card-body">
        <div class="row quick-links">
                                                                                                                                                                            <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                        <a href="http://localhost/dacsn/admin/view:comments" class="btn btn-link"><i class="mdi mdi-comment-account"></i><span>Bình luận</span></a>
                    </div>
                                                                                                                                        <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                        <a href="http://localhost/dacsn/admin/order" class="btn btn-link"><i class="mdi mdi-shopping"></i><span>Xem đơn đặt hàng</span></a>
                    </div>
                            
                                                                                                                                                                <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                        <a href="http://localhost/dacsn/admin/view:content" class="btn btn-link"><i class="mdi mdi-earth"></i><span>Quản lý trang web</span></a>
                    </div>
                                                                                                                                        <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                        <a href="http://localhost/dacsn/admin/view:modules" class="btn btn-link"><i class="mdi mdi-view-grid-plus"></i><span>Quản lý mô-đun</span></a>
                    </div>
                                                                                                                                        <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                        <a href="http://localhost/dacsn/admin/view:files" class="btn btn-link"><i class="mdi mdi-file-check"></i><span>Quản lý tập tin</span></a>
                    </div>
                                                    
            
                                                                                                                                                                                                                <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                            <a href="http://localhost/dacsn/admin/view:marketplace" class="btn btn-link"><i class="mdi mdi-fruit-cherries"></i><span>Đi tới Thị trường</span></a>
                        </div>
                                                                                                                                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                            <a href="http://localhost/dacsn/admin/view:updates" class="btn btn-link"><i class="mdi mdi-update"></i><span>Cập nhật</span></a>
                        </div>
                                                                                                                                                                    <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                            <a href="https://microweber.com/contact-us" class="btn btn-link"><i class="mdi mdi-penguin"></i><span>Đề xuất một tính năng</span></a>
                        </div>
                                                                        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/6f22495ef036036e2f53ac2bc35de3ce8d07d310.blade.php ENDPATH**/ ?>