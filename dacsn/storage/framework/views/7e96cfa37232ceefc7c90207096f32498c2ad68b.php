...
} elseif ($_instance->childHasBeenRendered('Wu99Dwm')) {
    $componentId = $_instance->getRenderedChildComponentId('Wu99Dwm');
    $componentTag = $_instance->getRenderedChildComponentTagName('Wu99Dwm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Wu99Dwm');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('Wu99Dwm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
    ...
    <header class="position-sticky sticky-top bg-white admin-navigation-colorscheme">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center py-1">
                ...
                <ul class="nav">
                                            <li class="mx-1">
                            <a href="http://localhost/dacsn/C%E1%BB%ACA-H%C3%80NG-MAY-%C4%90%E1%BB%92NG-PH%E1%BB%A4C-CH%E1%BA%A4T-L%C6%AF%E1%BB%A2NG-GI%C3%81-R%E1%BA%BA?editmode=n" class="btn btn-outline-success btn-rounded btn-sm-only-icon go-live-edit-href-set go-live-edit-href-set-view">
                                <i class="mdi mdi-earth"></i><span class="d-none d-md-block ml-1">Trang mạng</span>
                            </a>
                        </li>
                        <li class="mx-1">
                            <a href="http://localhost/dacsn/C%E1%BB%ACA-H%C3%80NG-MAY-%C4%90%E1%BB%92NG-PH%E1%BB%A4C-CH%E1%BA%A4T-L%C6%AF%E1%BB%A2NG-GI%C3%81-R%E1%BA%BA?editmode=y" class="btn btn-primary btn-rounded btn-sm-only-icon go-live-edit-href-set">
            ...
            <ul class="nav flex-column" id="mw-admin-main-navigation">
                <li class="nav-item">
                    <a href="http://localhost/dacsn/admin/" class="nav-link ">
                        ...
                        <div class="dropdown-menu">
                            <a href="http://localhost/dacsn/admin/page" class="dropdown-item  active ">
...
<div class="form-group text-center">
    ...
    <main class="module-">
                    ...
                    <div class=" module module-content-edit " content_id="2" content_type="page" id="main-content-edit-admin" data-type="content/edit" parent-module="content/edit" parent-module-id="main-content-edit-admin">
...
<div class="in-window">
    ...
    <form method="post" class="mw_admin_edit_content_form  " action="http://localhost/dacsn/api/page/2" id="quickform-edit-content" autocomplete="off">

                    <input name="_method" type="hidden" value="PATCH">
        
        <input type="hidden" name="id" id="mw-content-id-value" value="2">
        <input type="hidden" name="subtype" id="mw-content-subtype" value="dynamic">
        <input type="hidden" name="subtype_value" id="mw-content-subtype-value-841039425" value="">
        <input type="hidden" name="content_type" id="mw-content-type mw-content-type-value-841039425" value="page">
        <input type="hidden" name="parent" id="mw-parent-page-value-841039425" value="0" class="">
        <input type="hidden" name="layout_file" id="mw-layout-file-value-841039425" value="layouts__blog.php">
        <input type="hidden" name="active_site_template" id="mw-active-template-value-841039425" value="default">
        ...
        <div class="position-relative">
            <div class="main-toolbar mw-modules-toolbar-back-button-holder">
                <a href="http://localhost/dacsn/admin/post" class="btn btn-link text-silver px-0">
                    <i class="mdi mdi-chevron-left"></i> Quay lại Blog                </a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 manage-content-body">
                ...
                <div class="content-title-field-row card style-1 mb-3 border-0" id="content-title-field-row">
                    <div class="card-header-fix">
                        <div class="card-header">
                            <h5><i class="mdi mdi-text text-primary mr-3"></i> <strong>Editing blog</strong></h5>
                            ...
                            <div id="content-title-field-buttons" class="mw-page-component-disabled">
                                                                            ...
                                                                            <a title="Chỉnh sửa trực tiếp" href="http://localhost/dacsn/blog?editmode=y" class="btn   btn-outline-primary  btn-sm  btn-sm-only-icon mw-admin-go-live-now-btn mx-1">
                                            <i class="mdi mdi-eye-outline me-1"></i><span>Chỉnh sửa trực tiếp</span>
                                        </a>
                            ...
                            <div class="form-group" id="slug-field-holder">
                                <label class="control-label">Blog tiêu đề</label>

                                
                                <input type="text" class="form-control" name="title" value="Blog" id="content-title-field" onkeyup="slugFromTitle();" autocomplete="">
                                    ...
                                    <span class="mw-admin-post-slug-text">
                                        ...
                                        <span class="contenteditable js-slug-base-url" data-bs-toggle="tooltip" data-title="edit" data-placement="right" contenteditable="true">blog</span>
                                    </span>
                                  </div>

                                <div class="d-none">
                                    <input autocomplete="off" name="url" id="edit-content-url" class="js-slug-base-url-changed edit-post-slug" type="text" value="blog">
                ...
                <div class="admin-manage-content-wrap">
                                                                        ...
                                                                        <div class=" module module-content-views-layout-selector " id="mw-quick-add-choose-layout-middle-pos" autoload="yes" template-selector-position="top" live-edit-btn-overlay="true" content-id="2" edit_page_id="2" inherit_from="0" small="true" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/layout_selector">
<script>
    ...
    mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12 = {
        set: function () {
        ...
        rend: function (url) {
            ...
            frame.onload = function (ev) {
                mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.set();
        ...
        next: function () {
            var index = mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector.selectedIndex;
            var next = mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector.options[index + 1] !== undefined ? (index + 1) : 0;
            mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view(next);
        },
        prev: function () {
            var index = mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector.selectedIndex;
            var prev = mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector.options[index - 1] !== undefined ? (index - 1) : mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector.options.length - 1;
            mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view(prev);
        },
        view: function (which) {
            mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector.selectedIndex = which;
            mw.$("#layout_selector3420ef6ab6774b0fdfc1ac861d52fe12 li.active").removeClass('active');
            mw.$("#layout_selector3420ef6ab6774b0fdfc1ac861d52fe12 li").eq(which).addClass('active');
            $(mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector).trigger('change');
        },
        setHeight: function () {
        ...
        generate: function (return_url) {
            ...
            var template = mw.$('#active_site_template_3420ef6ab6774b0fdfc1ac861d52fe12 option:selected').val();
            var layout = mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12').val();
            var is_shop = mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12 option:selected').attr('data-is-shop');
            var ctype = mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12 option:selected').attr('data-content-type');
            var stype = mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12 option:selected').attr('data-subtype');
            var stype_val = mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12 option:selected').attr('data-subtype-value');
            var inherit_from = mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12 option:selected').attr('inherit_from');


            var root = document.querySelector('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12');
            ...
            var iframe_url = 'http://localhost/dacsn/blog?no_editmode=true' + preview_template_param + preview_layout_param + '&content_id=2' + inherit_from_param + preview_layout_content_type_param
            if (return_url == undefined) {
                mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.rend(iframe_url);
                            } else {
                return (iframe_url);
            }
    ...
    $(document).ready(function () {
        ...
        mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.selector = document.getElementById('active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12');

        $('select#active_site_template_3420ef6ab6774b0fdfc1ac861d52fe12').on("change", function (e) {
            ...
            if (parent_module != undefined) {
              ...
              //  $(this).selectpicker('destroy');
                ...
                mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.generate();
        ...
        mw.$('#active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12').on("change", function (e) {
            mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.generate();
            mw.trigger('templateChanged');
        });
    ...
    <div class="layouts_box_holder">
        <div class="content-title-field-row card style-1  mb-3">
            <div class="card-header">
                <h5><i class="mdi mdi-text-box-check-outline text-primary mr-3"></i>
                                            ...
                                            <strong>Bản mẫu</strong> - New World                                    </h5>
                <div></div>
            </div>
            <div class="card-body pt-3">
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="control-label">Chọn bố cục trang</label>
                                            <small class="text-muted d-block mb-2">Chọn một trang từ mẫu hiện tại</small>
                                            <div>
                                                <select name="preview_layout_file" class="selectpicker mw-edit-page-layout-selector" data-width="100%" data-live-search="true" data-size="7" id="active_site_layout_3420ef6ab6774b0fdfc1ac861d52fe12" autocomplete="off">
                                                                                                                                                                                                                                                                                                <option value="index.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('0');" data-index="0" data-layout_file="index.php" data-content-type="static" title="Home">
                                                                Home                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__shop.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('1');" data-index="1" data-layout_file="layouts__shop.php" data-content-type="dynamic" data-is-shop="y" title="Shop">
                                                                Shop        (shop)                                                             </option>
                                                                                                                                                                                                                                                <option value="layouts__blog.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('2');" data-index="2" data-layout_file="layouts__blog.php" selected data-content-type="dynamic" title="Blog">
                                                                Blog                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__services.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('3');" data-index="3" data-layout_file="layouts__services.php" data-content-type="static" title="Services">
                                                                Services                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__about.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('4');" data-index="4" data-layout_file="layouts__about.php" data-content-type="static" title="About us">
                                                                About us                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__contacts.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('5');" data-index="5" data-layout_file="layouts__contacts.php" data-content-type="static" title="Contacts">
                                                                Contacts                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__sign-up.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('6');" data-index="6" data-layout_file="layouts__sign-up.php" data-content-type="static" title="Sign up">
                                                                Sign up                                                                </option>
                                                                                                                                                                                                                                                <option value="forgot_password.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('7');" data-index="7" data-layout_file="forgot_password.php" data-content-type="static" title="Forgot password">
                                                                Forgot password                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__text-page.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('8');" data-index="8" data-layout_file="layouts__text-page.php" data-content-type="static" title="Text page">
                                                                Text page                                                                </option>
                                                                                                                                                                                                                                                <option value="login.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('9');" data-index="9" data-layout_file="login.php" data-content-type="static" title="Login">
                                                                Login                                                                </option>
                                                                                                                                                                                                                                                <option value="register.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('10');" data-index="10" data-layout_file="register.php" data-content-type="static" title="Register">
                                                                Register                                                                </option>
                                                                                                                                                                                                                                                <option value="404.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('11');" data-index="11" data-layout_file="404.php" data-content-type="static" title="Error 404">
                                                                Error 404                                                                </option>
                                                                                                                                                                                                                                                <option value="clean.php" onclick="mw.templatePreview3420ef6ab6774b0fdfc1ac861d52fe12.view('12');" data-index="12" data-layout_file="clean.php" data-is-default="true" data-content-type="static" title="Clean">
                                                                Clean                                                                </option>
                                                                                                                                                                                                                            <option title="Thừa kế" value="inherit">
                                                            Thừa kế                                                        </option>
                                                                                                    </select>
                                            </div>
        ...
        <div class="card style-1  mb-3">
            <div class="card-body pt-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="font-weight-bold">Bản xem trước mẫu</h5>
                        <small class="text-muted">Sử dụng các trường ở trên để thực hiện thay đổi.</small>
                    </div>
                </div>
...
<div id="settings-tabs">
    <div class="card style-1 mb-3 images">
        ...
        <div class="card-body pt-3">
            <div class="pictures-admin-content-type-page module module-pictures-admin " data-mw-title="Picture Gallery" id="edit-post-gallery-main" for="content" content_type="page" for-id="2" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="pictures/admin">    <script type="text/javascript">
    ...
    mw_admin_pictures_upload_browse_existing = function () {
        ...
        $(dialog.iframe).on('load', function () {
            this.contentWindow.mw.on.hashParam('select-file', function (pval) {
                after_upld(pval, 'save', 'content', '2', 'edit-post-gallery-main');

                after_upld(pval, 'done', 'content', '2', 'edit-post-gallery-main');
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f0635acc0fb">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f0635acc0fb"></div>



    <div class="admin-thumbs-holder">
                    <div class=" module module-pictures-admin-backend-sortable-pics-list " id="edit-post-gallery-main-pictures-admin-backend-sortable-pics-list" for="content" for_id="2" parent-module-id="edit-post-gallery-main" parent-module="pictures/admin" data-type="pictures/admin_backend_sortable_pics_list">
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0635af2cc0');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f0635af2cc0',
            nav: 'dropdown',
            footer: false,
            boxed: false,
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            ...
            after_upld(url, 'Result', 'content', '2', 'edit-post-gallery-main-pictures-admin-backend-sortable-pics-list');
            after_upld(url, 'done');
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f0635af2cc0" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f0635af2cc0');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f0635af2cc0');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f0635af2cc0',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0635af2cc0 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0635af2cc0").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0635af2cc0").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f0635af2cc0").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f0635af2cc0").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f0635af2cc0">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f0635acc0fb');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f0635acc0fb',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            var url = res && res.src ? res.src : res;
            after_upld(url, 'Result', 'content', '2', 'edit-post-gallery-main');
            after_upld(url, 'done');
            if (mw._postsImageUploader.settings.hideHeader) {
                mw._postsImageUploader.hide()
            } else {
        ...
        <div class="card style-1 mb-3 card-collapse fields js-custom-fields-card-tab">
            ...
            <div class="card-body py-0">
                <div class="collapse" id="custom-fields-settings">
                    <div class=" module module-custom-fields-admin " data-mw-title="Custom fields" content-id="2" suggest-from-related="true" list-preview="true" id="fields_for_post_2" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="custom_fields/admin">


<div class="card style-1 mb-3 ">
    <div class="card-header">
        <div class=" module module-admin-modules-info-module-title " id="fields-for-post-2-admin-modules-info-module-title" for-module="custom_fields/admin" parent-module-id="fields_for_post_2" parent-module="custom_fields/admin" data-type="admin/modules/info_module_title"><h5>
        ...
        <div class="settings-wrapper">
            ...
            <script>
                ...
                function addCustomFieldByExisting(fieldId) {
                    ...
                    //   mw.custom_fields.copy_field_by_id(fieldId, 'content', '2');
                ...
                $(document).ready(function () {
                    ...
                    mw.$('.js-cf-options').on('change', function () {
                        ...
                        if (copyof == false) {
                            ...
                            // mw.custom_fields.copy_field_by_id(copyof, 'content', '2');
                        }
                    });
                });
            ...
            <div class="module-live-edit-settings">
                <div id="custom-field-editor" class="mw-ui-box mw-ui-box-content" style="display: none">
                    ...
                    <div class="custom-field-edit">
                        ...
                        <div class="mw-admin-custom-field-edit-item-wrapper">
                            <div class="mw-admin-custom-field-edit-item mw-admin-custom-field-edit-fields_for_post_2"></div>
                        </div>
                    </div>
                </div>
                ...
                <div id="custom-fields-box">
                    ...
                    <div class=" module module-custom-fields-list " data-type="custom_fields/list" for="content" rel_id="2" list-preview="true" id="mw_custom_fields_list_preview" parent-module-id="fields_for_post_2" parent-module="custom_fields/admin"><script>
...
<script>
    ...
    $(document).ready(function (){
        ...
        <div class=" module module-help-modal-with-button " id="fields-for-post-2-help-modal-with-button" for_module="custom_fields" parent-module-id="fields_for_post_2" parent-module="custom_fields/admin" data-type="help/modal_with_button"><script>
...
<a href="javascript:;" onclick="openModalHelpReadmeMd('custom_fields');"><i class="fa fa-info-circle"></i> Cứu giúp</a>
    ...
    <div class=" module module-content-views-advanced-settings " id="main-content-edit-admin-content-views-advanced-settings" content-id="2" content-type="page" subtype="dynamic" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/advanced_settings">    <script type="text/javascript">
        mw.lib.require('mwui_init');
    </script>
    <script type="text/javascript">
    ...
    <div class=" module module-content-views-settings-from-template " id="main-content-edit-admin-content-views-advanced-settings-content-views-settings-from-template" content-type="page" content-id="2" parent-module-id="main-content-edit-admin-content-views-advanced-settings" parent-module="content/views/advanced_settings" data-type="content/views/settings_from_template">
</div>
    ...
    <div class="card style-1 mb-3 card-collapse">
            ...
            <div class="collapse" id="advanced-settings">
                ...
                <script>
                    ...
                    open_edit_related_content_modal = function($content_id) {
                        ...
                        var dialog = mw.top().dialogIframe({
                            url: 'http://localhost/dacsn/module/?type=content/views/related_content_list&live_edit=true&id=open_edit_related_content_modal__opened__module&content_id='+$content_id+'&from_url=http://localhost/dacsn/',
                            title: 'Edit related content',
                            id: modal_id,
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-md-8">
                        <label class="control-label">Nội dung liên quan:</label>
                        <small class="text-muted d-block mb-3">Bạn có thể thêm nội dung liên quan vào bài đăng hoặc sản phẩm của mình</small>
                        <a class="btn btn btn-outline-primary btn-sm" href="javascript:open_edit_related_content_modal('2');">Chỉnh sửa liên quan</a>
                    </div>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-md-12 text-center text-md-left">
                        <label class="control-label mt-3">Lựa chọn khác:</label>
                        <small class="text-muted d-block mb-3">Chọn thêm các tùy chọn</small>
                        <a class="btn btn-outline-primary btn-sm" href="javascript:mw.copy_current_page('2');">Bản sao</a> 
                        <a class="btn btn-outline-primary btn-sm" href="javascript:mw.reset_current_page('2');">Đặt lại nội dung</a>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Là nhà</label>
                                <small class="text-muted d-block mb-2">Nếu có, trang này sẽ là Trang chủ của bạn</small>
                                <div class="custom-control custom-switch pl-0">
                                    <label class="d-inline-block mr-5" for="is_home">Không</label>
                                    <input type="checkbox" name="is_home" class="custom-control-input" id="is_home" data-value-checked="1" data-value-unchecked="0">
                                    <label class="custom-control-label" for="is_home">Đúng</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label>Là cửa hàng</label>
                                <small class="text-muted d-block mb-2">Nếu có, trang này sẽ chấp nhận các sản phẩm được thêm vào</small>
                                <div class="custom-control custom-switch pl-0">
                                    <label class="d-inline-block mr-5" for="is_shop">Không</label>
                                    <input type="checkbox" name="is_shop" class="custom-control-input" id="is_shop" data-value-checked="1" data-value-unchecked="0">
                                    <label class="custom-control-label" for="is_shop">Đúng</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div>
                                <small>
                                    Tôi: <span class="mw-admin-edit-post-display-id-at-value">2</span>
                    ...
                    <div class="row  ">
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-sm btn-link" data-bs-toggle="collapse" data-bs-target="#set-a-specific-publish-date">Đặt một ngày xuất bản cụ thể</button>
                                    ...
                                    <script>
                                        $(function () {
                                            ...
                                            <div class="mw-admin-edit-post-created-at" onclick="mw.adm_cont_enable_edit_of_created_at()">
                                                <small>
                                                    Được tạo ra: <span class="mw-admin-edit-post-display-created-at-value">2020-01-21 10:33:19</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-created-at-value" style="display:none" type="text" name="created_at" value="2020-01-21 10:33:19">
                                                </small>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mw-admin-edit-post-updated-at" onclick="mw.adm_cont_enable_edit_of_updated_at()">
                                                <small>
                                                    Cập nhật vào: <span class="mw-admin-edit-post-display-updated-at-value">2023-02-18 05:08:39</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-updated-at-value" style="display:none" type="text" name="updated_at" value="2023-02-18 05:08:39">
                                                </small>
                                            </div>
                                        </div>
                                                                    </div>
                        ...
                        <div class="col-12">
                            <div class="mw-ui-field-holder"><br>
                                <span class="font-weight-bold">Loại nội dung:  </span>
                                ...
                                <div class="collapse" id="content-type-settings">
                                    <div class="alert alert-dismissible alert-warning mt-3">
                                        ...
                                        <p class="mb-0">Không thay đổi các cài đặt này trừ khi bạn biết mình đang làm gì.</p>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>
                                                Thay đổi loại nội dung                                                <small data-bs-toggle="tooltip" data-title="Thay đổi loại nội dung thành khác với 'page' là hành động nâng cao. Vui lòng đọc tài liệu và cân nhắc không thay đổi loại nội dung"></small>
                                            </label>
                                        ...
                                        <div class="col-md-6">
                                            <label>
                                                Thay đổi loại phụ nội dung                                                <small data-bs-toggle="tooltip" data-title="Thay đổi loại nội dung thành khác với 'dynamic' là hành động nâng cao. Vui lòng đọc tài liệu và cân nhắc không thay đổi loại nội dung"></small>
                                            </label>
        ...
        <div class="alert alert-danger" role="alert">
            ...
            <a class="btn btn-outline-danger btn-sm" id="mw-admin-content-edit-inner-delete-curent-content-btn" href="javascript:mw.del_current_page('2');">Xóa nội dung</a>
...
<script>
    ...
    mw.edit_content.close_alert = function () {
        ...
        mw.$('#post-added-alert-841039425').hide();

    };

    mw.edit_content.load_page_preview = function (element_id) {
        var element_id = element_id || 'mw-admin-content-iframe-editor';
        var parent_page = mw.$('#mw-parent-page-value-841039425', '#main-content-edit-admin').val();
        var content_id = mw.$('#mw-content-id-value', '#main-content-edit-admin').val();
        var content_type = mw.$('#mw-content-type-value-841039425', '#main-content-edit-admin').val()
        var subtype = mw.$('#mw-content-subtype', '#main-content-edit-admin').val();
        var subtype_value = mw.$('#mw-content-subtype-value-841039425', '#main-content-edit-admin').val();
        var active_site_template = $('#mw-active-template-value-841039425', '#main-content-edit-admin').val();
        var active_site_layout = $('#mw-layout-file-value-841039425').val();
    ...
    mw.edit_content.set_category = function (id) {
        ...
        if (names.length > 0) {
            mw.$('#mw-parent-page-value-841039425').val(names[0]).trigger("change");
        } else {
            mw.$('#mw-parent-page-value-841039425').val(0).trigger("change");
        }
    }
...
<script>
    $(mwd).ready(function () {
        ...
        mw.edit_content.load_editor();
                // mw.edit_content.render_category_tree("841039425");
        mw.$("#quickform-edit-content").submit(function () {
            mw.edit_content.handle_form_submit();
            return false;
        });
                mw.$(".mw-admin-go-live-now-btn").attr('content-id', 2);
                mw.$('#mw-parent-page-value-841039425').on('change', function (e) {
        ...
        mw.$(".admin-manage-toolbar").on("mousemove", function () {
            mw.tools.removeClass(document.body, 'editorediting');
                ...
                <script>
        $(document).ready(function () {
            $('.go-live-edit-href-set').attr('href', 'http://localhost/dacsn/blog?editmode=y');
            $('.go-live-edit-href-set-view').attr('href', 'http://localhost/dacsn/blog?editmode=n');
        });
    </script>
...
<div class="col-md-4 manage-content-sidebar">
    ...
    <div class=" module module-content-views-edit-default-sidebar-variants " id="main-content-edit-admin-content-views-edit-default-sidebar-variants" content-id="2" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/edit_default_sidebar_variants">
</div>
    ...
    <div class="card style-1 mb-3 categories js-sidebar-categories-card">
            <div class="card-body pt-3 pb-1">
                <div class="row">
                                            ...
                                            <div class="col-12">
                            <strong>Chọn trang mẹ</strong>

                            <div class="quick-parent-selector mt-2">
                                <div class=" module module-content-views-selector " id="main-content-edit-admin-content-views-selector" no-parent-title="Không có trang mẹ" field-name="parent_id_selector" change-field="parent" selected-id="0" remove_ids="2" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/selector">


<div id="tree-item-selector-63f0635adf780"></div>
...
<script>
    ...
    ;(function (){
        function tree() {
            var selected = [];
            mw.admin.tree('#tree-item-selector-63f0635adf780', {
                options: {
        ...
        if (document.readyState !== 'loading') {
            ...
            <div class="card-body pt-3">
                                    ...
                                    <div class=" module module-menu " id="main-content-edit-admin-menu" data-mw-title="Menu" view="edit_page_menus" content_id="2" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="menu">

<div class="row mb-3">
    <div class="col-12">
        <strong>Thêm vào Điều hướng</strong>
    </div>
</div>

<div class="position-relative" id="menu-selector-item">
            <div id="mw-menu-selector-list-63f0635ae85fc" class="mw-menu-selector-list">
                            <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="menuid-3">Footer Menu</label>
                            ...
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-5" class="custom-control-input" name="add_content_to_menu[]" value="5" type="checkbox" data-menu-key="top_menu_1">
                        <label class="custom-control-label" for="menuid-5">Top Menu 1</label>
                    </div>
                </div>
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-6" class="custom-control-input" name="add_content_to_menu[]" value="6" type="checkbox" data-menu-key="top_menu_2">
                        <label class="custom-control-label" for="menuid-6">Top Menu 2</label>
                    </div>
                </div>
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-7" class="custom-control-input" name="add_content_to_menu[]" value="7" type="checkbox" data-menu-key="footer_menu_1">
                        <label class="custom-control-label" for="menuid-7">Footer Menu 1</label>
                    </div>
                </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/7bce8a1f30d26924573aaa88b72b9208c3c5a3de.blade.php ENDPATH**/ ?>