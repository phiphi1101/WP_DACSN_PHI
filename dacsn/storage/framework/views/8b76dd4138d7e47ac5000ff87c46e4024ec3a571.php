...
} elseif ($_instance->childHasBeenRendered('ht5tGP7')) {
    $componentId = $_instance->getRenderedChildComponentId('ht5tGP7');
    $componentTag = $_instance->getRenderedChildComponentTagName('ht5tGP7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ht5tGP7');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('ht5tGP7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class=' module module-users-edit-user ' id='mw-main-module-backend-users-edit-user'  edit-user="3"   parent-module-id="mw-main-module-backend"   parent-module="users"   data-type="users/edit_user"  >
...
<script>mw.require("files.js");</script>
        ...
        var userId = 3;
        DeleteUserAdmin3 = function ($user_id) {
        ...
        LoginAsUserFromAdmin3 = function ($user_id) {
        ...
        var isValid = function () {
            var valid = true;
            mw.$('[name="email"], [name="text"]', '#users_edit_63f06fa138af5').each(function () {
        ...
        SaveAdminUserForm3 = function () {
            ...
            mw.form.post(mw.$('#users_edit_63f06fa138af5'), 'http://localhost/dacsn/api/user/3', function (scopeEl) {
                if (this.error) {
    ...
    <div class="card style-1 bg-light mb-3">
        <div class="card-header d-flex">
            <h5>
                <i class="mdi mdi-account-plus text-primary mr-3"></i> <strong>Người dùng biên tập</strong>
            </h5>

            <button id="user-save-button-top" class="btn btn-success btn-sm floar-end" onclick="SaveAdminUserForm3()">Lưu lại</button>

        </div>
        <div class="card-body pt-3">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="module-users-edit-user user-id-3" id="users_edit_63f06fa138af5">
                        ...
                        <div class="d-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" value="Loi">
                            </div>


                            <div class="form-group">
                                <label class="control-label">Mật khẩu</label>
                                                                    <span class="mw-ui-link" onclick="reset_password();$(this).hide()">Đổi mật khẩu</span>
                                                                <div class="input-group input-group-password mb-3 append-transparent semi_hidden js-reset-password">
                                    <input type="password" disabled name="password" class="form-control" id="reset_password">
                            ...
                            <div class="form-group semi_hidden js-reset-password">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="first_name" value="Lợi">
                            </div>

                            <div class="form-group">
                                <label class="control-label">Họ</label>
                                <input type="text" class="form-control" name="last_name" value="Ngô">
                            </div>

                            <div class="form-group">
                                <label class="control-label">E-mail</label>
                                <input type="email" class="form-control" name="email" value="110120060@st.tvu.edu.vn">
                            </div>

                            <div class="form-group">
                                <label class="control-label">Điện thoại</label>
                                <input type="text" class="form-control" name="phone" value="0385833858">
                            </div>
                            ...
                            <div class="collapse" id="advanced-settings">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="api_key" value="">
                                        ...
                                        <a onclick="LoginAsUserFromAdmin3('3')" class="btn btn-primary btn-sm">Đăng nhập với tư cách người dùng</a>
                                        <a onclick="DeleteUserAdmin3('3')" class="btn btn-danger btn-sm ml-2">Xóa người dùng</a>
                                    </div>
                                    ...
                                    <div class="export-label d-flex align-items-center justify-content-center-x">
                                        <a href="http://localhost/dacsn/api/users/export_my_data?user_id=3" class="btn btn-link px-0">Xuất dữ liệu người dùng</a>
                                         
                                    </div>
                                    <div class="export-label d-flex align-items-center justify-content-center-x">

                                        <a href="javascript:mw_admin_tos_popup(3)" class="btn btn-link px-0">Nhật ký thỏa thuận điều khoản</a>
                                         
                                    </div>
                                    <div class="export-label d-flex align-items-center justify-content-center-x">

                                        <a href="javascript:mw_admin_login_attempts_popup(3)" class="btn btn-link px-0">Cố gắng đăng nhập</a>
                                    </div>
                                                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button id="user-save-button" class="btn btn-success btn-sm" onclick="SaveAdminUserForm3()">Lưu lại</button>
            </div>
        </div>
    </div>
    </div></div>        
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/3dbe9ac703710326663d05df01a76ab0068340df.blade.php ENDPATH**/ ?>