<div class="col-md-5 col-12 ps-0 d-flex align-items-center mb-md-0 mb-4">
    ...
    <div class="btn-group">
        <a href="#" wire:click="setDisplayType('card')" class="btn mw-content-vision-tabs <?php if($displayType=='card'): ?> active <?php endif; ?>">
            ...
            <?php echo e(_e('Card')); ?> </a>
        <a href="#" wire:click="setDisplayType('table')" class="btn mw-content-vision-tabs <?php if($displayType=='table'): ?> active <?php endif; ?>">
            ...
            </svg> <?php echo e(_e('Table')); ?> </a>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\dacsn\src\MicroweberPackages\Content\resources\views/admin/content/livewire/components/display-as.blade.php ENDPATH**/ ?>