...
} elseif ($_instance->childHasBeenRendered('FNgEwak')) {
    $componentId = $_instance->getRenderedChildComponentId('FNgEwak');
    $componentTag = $_instance->getRenderedChildComponentTagName('FNgEwak');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FNgEwak');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('FNgEwak', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:131px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="XgU3pZCkfy5Ir1OYkZup" wire:initial-data='{"fingerprint":{"id":"XgU3pZCkfy5Ir1OYkZup","name":"admin-posts-list","locale":"vi_VN","path":"admin\/post","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/post?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"1e30dc24","data":{"model":"MicroweberPackages\\Post\\Models\\Post","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"ca2d5484b9d378e7ade526a4e78a571b782c9042f6dd86f818d21060fb91b58f"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:KRYoVGuoCKXORBzbGfDE -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/72dc7afeb6183930f8e553808c1963b7a089fea5.blade.php ENDPATH**/ ?>