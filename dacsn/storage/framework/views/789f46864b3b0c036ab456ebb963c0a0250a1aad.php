...
} elseif ($_instance->childHasBeenRendered('LHwUJhy')) {
    $componentId = $_instance->getRenderedChildComponentId('LHwUJhy');
    $componentTag = $_instance->getRenderedChildComponentTagName('LHwUJhy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LHwUJhy');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('LHwUJhy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:140px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:90px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:147px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:144px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:94px;"></div>
                </div>
            </div>
    ...
    <div class="module-content">
        ...
        <div wire:id="ztZjBPjFK8Jl9Z6Mfd9f" wire:initial-data='{"fingerprint":{"id":"ztZjBPjFK8Jl9Z6Mfd9f","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"bf5a32e2","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"a187fe15f74aa22cc1f80852d8d79775df79d02f5a90dab2ab83767cb3357d03"}}' class="card style-1 mb-3">
...
<script>
    ...
    <a href="http://localhost/dacsn/admin/post/25/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-bg-section-team-1346743884.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/21/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-cruises-result-2244902104.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/20/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-blog-detail-2105852368.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/19/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-blog-image-1-2291643006.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/18/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-homepage-default-banner-1879749260.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/17/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-7-480041557125030-3767769709.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/shop/product/9/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-2-698841557124343-889936889.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/shop/product/10/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-5-857941557124344-445398913.webp" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/shop/product/11/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-14-824291557125318-1967067830.webp" class="rounded-full">
    </div>
...
<!-- Livewire Component wire-end:tAvtg1Itta8aS3ulyxOg -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/cdcd0a37f909283f0f4a977f6c8200e4b4033d61.blade.php ENDPATH**/ ?>