...
} elseif ($_instance->childHasBeenRendered('XdPFT63')) {
    $componentId = $_instance->getRenderedChildComponentId('XdPFT63');
    $componentTag = $_instance->getRenderedChildComponentTagName('XdPFT63');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XdPFT63');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('XdPFT63', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="UOoFuqh2FoJP99f8Ijnc" wire:initial-data='{"fingerprint":{"id":"UOoFuqh2FoJP99f8Ijnc","name":"admin-posts-list","locale":"vi_VN","path":"admin\/post","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/post?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"012e557d","data":{"model":"MicroweberPackages\\Post\\Models\\Post","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"4d38e20060fae3998004349cbb130a143e0b79e4a6f2196a2c64485b058d10cc"}}' class="card style-1 mb-3">
    ...
    <div class="col d-flex justify-content-md-between justify-content-center align-items-center px-0">
        ...
        <div>
                            ...
                            <a href="http://localhost/dacsn/admin/post/create" class="btn btn-link btn-sm">Thêm bài đăng</a>
...
<script>
    ...
    <select class="form-select form-select-sm" wire:model="paginate">
                ...
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="30" id="products-30" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-30" class="custom-control-label"></label>
                        </div>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/575?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/30/edit" class="btn btn-link p-0">
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/SAMSUNG-A7-2018">
        <small class="text-muted">http://localhost/dacsn/SAMSUNG-A7-2018</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/30/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/30/edit" class="btn btn-outline-success btn-sm">Live Edit</a>

        <a href="javascript:mw.admin.content.delete('30');" class="btn btn-outline-danger btn-sm js-delete-content-btn-30">Delete</a>
        </div>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="29" id="products-29" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-29" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/userfiles/cache/thumbnails/640/tn-screenshot-2023-02-18-132155-2860429364.webp" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/29/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            Giày, dép giá sỉ Trà Vinh
        </h5>
    </a>
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/Gi%C3%A0y-d%C3%A9p-gi%C3%A1-s%E1%BB%89-Tr%C3%A0-Vinh">
        <small class="text-muted">http://localhost/dacsn/Giày-dép-giá-sỉ-Trà-Vinh</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/29/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/29/edit" class="btn btn-outline-success btn-sm">Live Edit</a>

        <a href="javascript:mw.admin.content.delete('29');" class="btn btn-outline-danger btn-sm js-delete-content-btn-29">Delete</a>
        </div>
    ...
    <a href="http://localhost/dacsn/admin/post/25/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('25');" class="btn btn-outline-danger btn-sm js-delete-content-btn-25">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">6 results found</span>
                </div>
...
<!-- Livewire Component wire-end:iwdAIi5v1UbNzEJTuSmH -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/e3c156a94d34e9495ea8eb6852c2cb23c24b20a1.blade.php ENDPATH**/ ?>