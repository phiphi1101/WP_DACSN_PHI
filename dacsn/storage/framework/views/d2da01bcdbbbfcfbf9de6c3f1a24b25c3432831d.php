...
} elseif ($_instance->childHasBeenRendered('KNHTmol')) {
    $componentId = $_instance->getRenderedChildComponentId('KNHTmol');
    $componentTag = $_instance->getRenderedChildComponentTagName('KNHTmol');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KNHTmol');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('KNHTmol', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/d8e417dc749361869a6ccba377742ab3761faf57.blade.php ENDPATH**/ ?>