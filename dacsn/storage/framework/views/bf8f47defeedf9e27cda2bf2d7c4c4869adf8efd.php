...
} elseif ($_instance->childHasBeenRendered('9oBW0Zq')) {
    $componentId = $_instance->getRenderedChildComponentId('9oBW0Zq');
    $componentTag = $_instance->getRenderedChildComponentTagName('9oBW0Zq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9oBW0Zq');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('9oBW0Zq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/f01b79449300aa4552d0fc5e599197ac08333e0e.blade.php ENDPATH**/ ?>