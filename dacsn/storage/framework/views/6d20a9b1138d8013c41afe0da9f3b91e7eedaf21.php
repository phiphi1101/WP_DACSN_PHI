...
} elseif ($_instance->childHasBeenRendered('Ou6XGfO')) {
    $componentId = $_instance->getRenderedChildComponentId('Ou6XGfO');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ou6XGfO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ou6XGfO');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('Ou6XGfO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="3m2tcHhR5GFyu2ca8lT0" wire:initial-data='{"fingerprint":{"id":"3m2tcHhR5GFyu2ca8lT0","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"ec94f247","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"c03ab1213d95a4cf2b9640cdc946aef7c48c6fe7fab0b4e4070d84e84ecf24d4"}}' class="card style-1 mb-3">
...
<script>
    ...
    <select class="form-select form-select-sm" wire:model="paginate">
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/509?saved" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/26/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/510?saved" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/page/5/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('5');" class="btn btn-outline-danger btn-sm js-delete-content-btn-5">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">9 results found</span>
                </div>
...
<!-- Livewire Component wire-end:Clq2LFjiiaDk7OD0ObPb -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/394ce4c248e21e47f8bd67bd27839314f3daf822.blade.php ENDPATH**/ ?>