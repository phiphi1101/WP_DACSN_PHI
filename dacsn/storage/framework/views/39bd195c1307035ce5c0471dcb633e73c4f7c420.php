...
} elseif ($_instance->childHasBeenRendered('i2HtcCa')) {
    $componentId = $_instance->getRenderedChildComponentId('i2HtcCa');
    $componentTag = $_instance->getRenderedChildComponentTagName('i2HtcCa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('i2HtcCa');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('i2HtcCa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<script>mw.require("files.js");</script>
        ...
        var isValid = function () {
            var valid = true;
            mw.$('[name="email"], [name="text"]', '#users_edit_63f06f6d13573').each(function () {
        ...
        SaveAdminUserForm0 = function () {
            ...
            mw.form.post(mw.$('#users_edit_63f06f6d13573'), 'http://localhost/dacsn/api/user', function (scopeEl) {
                if (this.error) {
        ...
        <div class="card-body pt-3">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="module-users-edit-user user-id-0" id="users_edit_63f06f6d13573">
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/60dc4ee885d1992dc1ad9f5824f1a652a7fa5c54.blade.php ENDPATH**/ ?>