...
} elseif ($_instance->childHasBeenRendered('JDKiY1S')) {
    $componentId = $_instance->getRenderedChildComponentId('JDKiY1S');
    $componentTag = $_instance->getRenderedChildComponentTagName('JDKiY1S');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JDKiY1S');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('JDKiY1S', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/6041df05a5996bd40797e855dce6a7c4db7187f7.blade.php ENDPATH**/ ?>