...
} elseif ($_instance->childHasBeenRendered('qGtBtWQ')) {
    $componentId = $_instance->getRenderedChildComponentId('qGtBtWQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('qGtBtWQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qGtBtWQ');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('qGtBtWQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class=' module module-users-edit-user ' id='mw-main-module-backend-users-edit-user'  edit-user="2"   parent-module-id="mw-main-module-backend"   parent-module="users"   data-type="users/edit_user"  >
...
<script>mw.require("files.js");</script>
        ...
        var userId = 2;
        DeleteUserAdmin2 = function ($user_id) {
        ...
        LoginAsUserFromAdmin2 = function ($user_id) {
        ...
        var isValid = function () {
            var valid = true;
            mw.$('[name="email"], [name="text"]', '#users_edit_63f065c886c83').each(function () {
        ...
        SaveAdminUserForm2 = function () {
            ...
            mw.form.post(mw.$('#users_edit_63f065c886c83'), 'http://localhost/dacsn/api/user/2', function (scopeEl) {
                if (this.error) {
    ...
    <div class="card style-1 bg-light mb-3">
        <div class="card-header d-flex">
            ...
            <button id="user-save-button-top" class="btn btn-success btn-sm floar-end" onclick="SaveAdminUserForm2()">Lưu lại</button>

        </div>
        <div class="card-body pt-3">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="module-users-edit-user user-id-2" id="users_edit_63f065c886c83">
                        ...
                        <div class="d-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" value="Han">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="first_name" value="Hân">
                            </div>

                            <div class="form-group">
                                <label class="control-label">Họ</label>
                                <input type="text" class="form-control" name="last_name" value="Lâm">
                            </div>
                            ...
                            <div class="collapse" id="advanced-settings">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="api_key" value="">
                                        ...
                                        <a onclick="LoginAsUserFromAdmin2('2')" class="btn btn-primary btn-sm">Đăng nhập với tư cách người dùng</a>
                                        <a onclick="DeleteUserAdmin2('2')" class="btn btn-danger btn-sm ml-2">Xóa người dùng</a>
                                    </div>
                                    ...
                                    <div class="export-label d-flex align-items-center justify-content-center-x">
                                        <a href="http://localhost/dacsn/api/users/export_my_data?user_id=2" class="btn btn-link px-0">Xuất dữ liệu người dùng</a>
                                         
                                    </div>
                                    <div class="export-label d-flex align-items-center justify-content-center-x">

                                        <a href="javascript:mw_admin_tos_popup(2)" class="btn btn-link px-0">Nhật ký thỏa thuận điều khoản</a>
                                         
                                    </div>
                                    <div class="export-label d-flex align-items-center justify-content-center-x">

                                        <a href="javascript:mw_admin_login_attempts_popup(2)" class="btn btn-link px-0">Cố gắng đăng nhập</a>
                                    </div>
                                                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button id="user-save-button" class="btn btn-success btn-sm" onclick="SaveAdminUserForm2()">Lưu lại</button>
            </div>
        </div>
    </div>
    </div></div>        
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/2bbc1ed02cfbcab89e7a2940bf4714a36cedc8e9.blade.php ENDPATH**/ ?>