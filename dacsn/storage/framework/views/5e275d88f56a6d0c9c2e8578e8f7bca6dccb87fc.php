...
} elseif ($_instance->childHasBeenRendered('JpgwGHP')) {
    $componentId = $_instance->getRenderedChildComponentId('JpgwGHP');
    $componentTag = $_instance->getRenderedChildComponentTagName('JpgwGHP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JpgwGHP');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('JpgwGHP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/bd50474117693bec9288521bb5deda69691a5fc5.blade.php ENDPATH**/ ?>