...
} elseif ($_instance->childHasBeenRendered('bLYUxSp')) {
    $componentId = $_instance->getRenderedChildComponentId('bLYUxSp');
    $componentTag = $_instance->getRenderedChildComponentTagName('bLYUxSp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bLYUxSp');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('bLYUxSp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/afd00c4630c5d389d223ff6f0fcee9471e6b82d4.blade.php ENDPATH**/ ?>