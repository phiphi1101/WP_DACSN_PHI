...
<body class="is_admin loading view-content action-categories">
...
} elseif ($_instance->childHasBeenRendered('kXGWh4G')) {
    $componentId = $_instance->getRenderedChildComponentId('kXGWh4G');
    $componentTag = $_instance->getRenderedChildComponentTagName('kXGWh4G');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kXGWh4G');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('kXGWh4G', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<script>
    ...
    function mw_select_page_for_editing($p_id) {
        ...
        //var active_item = $('#pages_tree_container_555753605 .active-bg').first();
        ...
        var active_item = $('#pages_tree_container_555753605 .content-item-' + active_item_is_parent).first();
        ...
        if (active_item_is_category ) {
            var active_item_parent_page = $('#pages_tree_container_555753605 .active-bg').parents('.have_category').first();
            if (active_item_parent_page.length) {
                 active_item_is_page = active_item_parent_page.attr('data-page-id');
            }
            else {
                active_item_parent_page = $('#pages_tree_container_555753605 .active-bg').parents('.is_page').first();
                if (active_item_parent_page.length) {
                     active_item_is_page = active_item_parent_page.attr('data-page-id');
                }
            }
    ...
    function mw_select_custom_content_for_editing($p_id, $type) {
        ...
        if (active_item_is_category != undefined) {
            ...
            var active_bg = document.querySelector('#pages_tree_container_555753605 .active-bg');
...
<div id="edit-content-row">
    ...
    <div id="pages_edit_container"  manage_categories='yes'    ></div>
</div>
</div>        
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/4ae3940c1e059010aa5a30b2e0ce6cd54b5aa6f6.blade.php ENDPATH**/ ?>