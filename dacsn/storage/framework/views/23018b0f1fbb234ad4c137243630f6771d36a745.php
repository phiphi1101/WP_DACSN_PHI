...
} elseif ($_instance->childHasBeenRendered('eQEkKda')) {
    $componentId = $_instance->getRenderedChildComponentId('eQEkKda');
    $componentTag = $_instance->getRenderedChildComponentTagName('eQEkKda');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eQEkKda');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('eQEkKda', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/4ef4e8c4495ca0cc6d68663d6864b90dd701d1a0.blade.php ENDPATH**/ ?>