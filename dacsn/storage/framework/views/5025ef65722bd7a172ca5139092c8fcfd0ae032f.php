...
} elseif ($_instance->childHasBeenRendered('VgrZwcw')) {
    $componentId = $_instance->getRenderedChildComponentId('VgrZwcw');
    $componentTag = $_instance->getRenderedChildComponentTagName('VgrZwcw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VgrZwcw');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('VgrZwcw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/04b8c6d9edb1fa12fc77c6d7c0b269ebb37fc1a7.blade.php ENDPATH**/ ?>