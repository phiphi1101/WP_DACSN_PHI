...
} elseif ($_instance->childHasBeenRendered('0SdnNqC')) {
    $componentId = $_instance->getRenderedChildComponentId('0SdnNqC');
    $componentTag = $_instance->getRenderedChildComponentTagName('0SdnNqC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0SdnNqC');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('0SdnNqC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/e135e6c87af94fd8b93684d6c28a800afa27ec4e.blade.php ENDPATH**/ ?>