...
} elseif ($_instance->childHasBeenRendered('uYXcMHz')) {
    $componentId = $_instance->getRenderedChildComponentId('uYXcMHz');
    $componentTag = $_instance->getRenderedChildComponentTagName('uYXcMHz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uYXcMHz');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('uYXcMHz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
                ...
                <div class="text-center">
                    <div class="d-inline-block mb-1">
                        <div class="img-circle-holder img-absolute w-80">
                            <img src="http://localhost/dacsn/api/image-generate-tn-request/540?saved"/>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/57046b29b6668f5f6e7d6cbe851fa2fcc53d15e1.blade.php ENDPATH**/ ?>