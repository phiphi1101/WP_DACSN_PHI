...
} elseif ($_instance->childHasBeenRendered('eoeLASG')) {
    $componentId = $_instance->getRenderedChildComponentId('eoeLASG');
    $componentTag = $_instance->getRenderedChildComponentTagName('eoeLASG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eoeLASG');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('eoeLASG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/78e0bf00753d3382dcfd25c3f9b9406938f4ad06.blade.php ENDPATH**/ ?>