...
} elseif ($_instance->childHasBeenRendered('6Ida9UH')) {
    $componentId = $_instance->getRenderedChildComponentId('6Ida9UH');
    $componentTag = $_instance->getRenderedChildComponentTagName('6Ida9UH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6Ida9UH');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('6Ida9UH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="Goc7bgv4m9u8xcAX80Dz" wire:initial-data='{"fingerprint":{"id":"Goc7bgv4m9u8xcAX80Dz","name":"admin-posts-list","locale":"vi_VN","path":"admin\/post","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/post?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"1e30dc24","data":{"model":"MicroweberPackages\\Post\\Models\\Post","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"45ad03c5381d28bf9fd62ec494245501aef449d2f146dd2172de96a245c10af8"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:ElG5oX6rldK2nRZ04ft9 -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/a5978ddcc6d3228d6572a72053cd9447a9f9a285.blade.php ENDPATH**/ ?>