...
} elseif ($_instance->childHasBeenRendered('dxcTn1w')) {
    $componentId = $_instance->getRenderedChildComponentId('dxcTn1w');
    $componentTag = $_instance->getRenderedChildComponentTagName('dxcTn1w');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dxcTn1w');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('dxcTn1w', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:159px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:109px;"></div>
                </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:140px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="07P2Tl6ThhUEBLxxRJMm" wire:initial-data='{"fingerprint":{"id":"07P2Tl6ThhUEBLxxRJMm","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"123e5fc6","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"be07b91f73b9fb468a4d729e52dd69511ae1c6ba215aa41e333437d497e70904"}}' class="card style-1 mb-3">
...
<script>
    ...
    <select class="form-select form-select-sm" wire:model="paginate">
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/550?saved" class="rounded-full">
    </div>
...
<!-- Livewire Component wire-end:3LLe05C7dQH1yXW2i57n -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/d04937224d312a5cf285e25100c22439146bf8ef.blade.php ENDPATH**/ ?>