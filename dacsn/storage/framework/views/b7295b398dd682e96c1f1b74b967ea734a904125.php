...
} elseif ($_instance->childHasBeenRendered('lmdKDzw')) {
    $componentId = $_instance->getRenderedChildComponentId('lmdKDzw');
    $componentTag = $_instance->getRenderedChildComponentTagName('lmdKDzw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lmdKDzw');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('lmdKDzw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:158px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="ehlLiAr4mLavtiOR236d" wire:initial-data='{"fingerprint":{"id":"ehlLiAr4mLavtiOR236d","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"0fa8d194","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"3674bf72a55ca3f73d913d7b89de715635d5fc3883c9eb5bdbef4384c0fd8898"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:62t1W26D53eKDOqUEaFT -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/dc1f7d3f1652dd893d40def77c1ae36586ba729c.blade.php ENDPATH**/ ?>