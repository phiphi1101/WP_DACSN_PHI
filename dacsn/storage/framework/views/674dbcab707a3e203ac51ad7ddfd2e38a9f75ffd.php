...
} elseif ($_instance->childHasBeenRendered('HdVObsy')) {
    $componentId = $_instance->getRenderedChildComponentId('HdVObsy');
    $componentTag = $_instance->getRenderedChildComponentTagName('HdVObsy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HdVObsy');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('HdVObsy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="card style-1 bg-light mb-3">
    <div class="card-header">
        <h5>
            <i class="mdi mdi-account-multiple text-primary mr-3"></i> <strong>Người dùng</strong>
        </h5>
    </div>
    ...
    <div class="card-body pt-3">
        <div class="row d-flex align-items-center justify-content-around">
            <div class="col-md-5 py-5">
                <h5 class="font-weight-bold">Quản lý người dùng của bạn</h5>
                <p>Bạn có thể tạo và quản lý người dùng, nhóm và vai trò.</p>
                <br/>

                <h6 class="font-weight-bold mb-1">Làm việc với người dùng</h6>
                <small class="text-muted d-block mb-2">Tạo và quản lý người dùng</small>
                <a href="http://localhost/dacsn/admin/view:modules/load_module:users/edit-user:0" class="btn btn-primary btn-sm"><i class="mdi mdi-account-plus"></i>Thêm người dùng mới</a>
                <a href="http://localhost/dacsn/admin/user" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-account-cog"></i>Quản lý người dùng</a>
                <br/>
                <br/>
                <br/>
                ...
                <div class="text-center">
                    <div class="d-inline-block mb-1">
                        <div class="img-circle-holder img-absolute w-80">
                            <img src="http://localhost/dacsn/userfiles/cache/thumbnails/120/tn-no-user-2362401833.webp"/>
                        </div>
                    </div>

                    <small class="d-block text-muted">Bạn đang đăng nhập</small>
                    <span class="d-block text-outline-primary font-weight-bold"></span>
                    <small class="d-block text-dark">User</small>

                    <a
                        href="http://localhost/dacsn/admin/view:modules/load_module:users/edit-user:1"
                        class="btn btn-outline-primary btn-sm mt-2">Chỉnh sửa hồ sơ</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/1832607e8a80767fecc0e26986980aa37cfd3dd6.blade.php ENDPATH**/ ?>