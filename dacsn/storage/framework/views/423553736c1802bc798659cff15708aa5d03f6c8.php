...
} elseif ($_instance->childHasBeenRendered('LqJ4WIV')) {
    $componentId = $_instance->getRenderedChildComponentId('LqJ4WIV');
    $componentTag = $_instance->getRenderedChildComponentTagName('LqJ4WIV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LqJ4WIV');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('LqJ4WIV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/4b764fb3849502a41dc5a3d73c194aa5b38055d8.blade.php ENDPATH**/ ?>