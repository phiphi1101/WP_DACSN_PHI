...
} elseif ($_instance->childHasBeenRendered('DWeQtQd')) {
    $componentId = $_instance->getRenderedChildComponentId('DWeQtQd');
    $componentTag = $_instance->getRenderedChildComponentTagName('DWeQtQd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DWeQtQd');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('DWeQtQd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="form-group text-center">
    ...
    <main class="module-blog">

                                    
                <div class=' module module-blog '   data-mw-title="Blog" view="admin"   backend="true"   id="mw-main-module-backend"   data-type="blog"   parent-module="blog"   parent-module-id="mw-main-module-backend"  >
    <div class=' module module-admin-modules-info ' id='mw-main-module-backend-admin-modules-info'  parent-module-id="mw-main-module-backend"   parent-module="blog"   data-type="admin/modules/info"  ><script>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/9462f2a51747c8494cb72d0acb14c71fcf3e3691.blade.php ENDPATH**/ ?>