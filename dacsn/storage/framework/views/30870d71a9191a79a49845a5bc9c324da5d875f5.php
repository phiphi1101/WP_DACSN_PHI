...
} elseif ($_instance->childHasBeenRendered('ch48T4t')) {
    $componentId = $_instance->getRenderedChildComponentId('ch48T4t');
    $componentTag = $_instance->getRenderedChildComponentTagName('ch48T4t');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ch48T4t');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('ch48T4t', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/4317a607134cdf4e21f0c0d3fdfd7feb326a1001.blade.php ENDPATH**/ ?>