...
} elseif ($_instance->childHasBeenRendered('wuO0aAH')) {
    $componentId = $_instance->getRenderedChildComponentId('wuO0aAH');
    $componentTag = $_instance->getRenderedChildComponentTagName('wuO0aAH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wuO0aAH');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('wuO0aAH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="in-window">
    ...
    <form method="post" class="mw_admin_edit_content_form  " action="http://localhost/dacsn/api/post/28" id="quickform-edit-content" autocomplete="off">
        ...
        <input type="hidden" name="subtype_value" id="mw-content-subtype-value-345758183" value="">
        <input type="hidden" name="content_type" id="mw-content-type mw-content-type-value-345758183" value="post">
        <input type="hidden" name="parent" id="mw-parent-page-value-345758183" value="2" class="">
        <input type="hidden" name="layout_file" id="mw-layout-file-value-345758183" value="inherit">
        <input type="hidden" name="active_site_template" id="mw-active-template-value-345758183" value="">
        ...
        <div class="row">
            <div class="col-md-8 manage-content-body">
                ...
                <div class="content-title-field-row card style-1 mb-3 border-0" id="content-title-field-row">
                    ...
                    $(mwd).ready(function () {
                        mweditor79881676698984 = mw.Editor({
                        selector: document.getElementById('79881676698984'),
                        mode: 'div',
                        smallEditor: false,
                        onSave: function(){
                ...
                </script><textarea class="form-control" name="content" rows="10" cols="50" onSaveCallback="mw.edit_content.handle_form_submit();" autocomplete="" id="79881676698984">Do nhu cầu kh&ocirc;ng sử dụng đến, n&ecirc;n m&igrave;nh cần thanh l&yacute; gấp chiếc Vison&nbsp;&lt;div&gt;Gi&aacute;: 28,000,000 VNĐ&lt;/div&gt;&lt;div&gt;Liện hệ: 0365524897 Ngọc Dung&lt;/div&gt;&lt;div&gt;Địa chỉ: 49 Sơn Th&ocirc;ng, Phường 8, Tp.Tr&agrave; Vinh&lt;/div&gt;</textarea>
                                                                                </div>
                                                                                                </div>
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f0656861264">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f0656861264"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0656870d8b');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f0656870d8b',
            nav: 'dropdown',
            footer: false,
            boxed: false,
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f0656870d8b" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f0656870d8b');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f0656870d8b');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f0656870d8b',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0656870d8b .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0656870d8b").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0656870d8b").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f0656870d8b").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f0656870d8b").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f0656870d8b">
                                <div class="admin-thumb-item admin-thumb-item-53" id="admin-thumb-item-53">


                                <span class="mw-post-media-img" style="background-image: url('http://localhost/dacsn/userfiles/cache/thumbnails/480/tn-vison-4238448211.webp');"></span>
            ...
            <div class="admin-thumb-item-uploader" id="admin-thumb-item-uploaderpic-sorter-63f0656870d8b">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f0656861264');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f0656861264',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
...
<script>
    ...
    mw.edit_content.close_alert = function () {
        ...
        mw.$('#post-added-alert-345758183').hide();

    };

    mw.edit_content.load_page_preview = function (element_id) {
        var element_id = element_id || 'mw-admin-content-iframe-editor';
        var parent_page = mw.$('#mw-parent-page-value-345758183', '#main-content-edit-admin').val();
        var content_id = mw.$('#mw-content-id-value', '#main-content-edit-admin').val();
        var content_type = mw.$('#mw-content-type-value-345758183', '#main-content-edit-admin').val()
        var subtype = mw.$('#mw-content-subtype', '#main-content-edit-admin').val();
        var subtype_value = mw.$('#mw-content-subtype-value-345758183', '#main-content-edit-admin').val();
        var active_site_template = $('#mw-active-template-value-345758183', '#main-content-edit-admin').val();
        var active_site_layout = $('#mw-layout-file-value-345758183').val();
    ...
    mw.edit_content.set_category = function (id) {
        ...
        if (names.length > 0) {
            mw.$('#mw-parent-page-value-345758183').val(names[0]).trigger("change");
        } else {
            mw.$('#mw-parent-page-value-345758183').val(0).trigger("change");
        }
    }
...
<script>
    $(mwd).ready(function () {
        ...
        mw.edit_content.load_editor();
                // mw.edit_content.render_category_tree("345758183");
        mw.$("#quickform-edit-content").submit(function () {
            ...
            return false;
                ...
                mw.$('#mw-parent-page-value-345758183').on('change', function (e) {
                ...
                <div class="row mb-3">
                    <div class="col-12">
                                ...
                                $(document).ready(function () {
                                    ...
                                    $('#mw-post-added-345758183').on('mousedown touchstart', function (e) {
                            ...
                            <div class="mw-tag-selector mt-3" id="mw-post-added-345758183">
                                ...
                                <div id="show-categories-tree">
                                    <div class="mw-admin-edit-page-primary-settings content-category-selector">
                                        <div class="mw-ui-field-holder">
                                            <div class="mw-ui-category-selector mw-ui-category-selector-abs mw-tree mw-tree-selector" id="mw-category-selector-345758183">
                                                                                                    <script>
                                                        $(document).ready(function () {
                                                            loadCategoriesTree();
                                                        });
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/39bf7b0c884f8c7d984a92f04ab119943e3a14c7.blade.php ENDPATH**/ ?>