...
} elseif ($_instance->childHasBeenRendered('GtI6rck')) {
    $componentId = $_instance->getRenderedChildComponentId('GtI6rck');
    $componentTag = $_instance->getRenderedChildComponentTagName('GtI6rck');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GtI6rck');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('GtI6rck', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="form-group text-center">
    ...
    <main class="module-">
                    ...
                    <div class=" module module-content-edit " content_id="28" content_type="post" id="main-content-edit-admin" data-type="content/edit" parent-module="content/edit" parent-module-id="main-content-edit-admin">
...
<div class="in-window">
    ...
    <form method="post" class="mw_admin_edit_content_form  " action="http://localhost/dacsn/api/post/28" id="quickform-edit-content" autocomplete="off">

                    <input name="_method" type="hidden" value="PATCH">
        
        <input type="hidden" name="id" id="mw-content-id-value" value="28">
        <input type="hidden" name="subtype" id="mw-content-subtype" value="post">
        <input type="hidden" name="subtype_value" id="mw-content-subtype-value-1507593415" value="">
        <input type="hidden" name="content_type" id="mw-content-type mw-content-type-value-1507593415" value="post">
        <input type="hidden" name="parent" id="mw-parent-page-value-1507593415" value="2" class="">
        <input type="hidden" name="layout_file" id="mw-layout-file-value-1507593415" value="inherit">
        <input type="hidden" name="active_site_template" id="mw-active-template-value-1507593415" value="">
        ...
        <div class="row">
            <div class="col-md-8 manage-content-body">
                ...
                <div class="content-title-field-row card style-1 mb-3 border-0" id="content-title-field-row">
                    <div class="card-header-fix">
                        <div class="card-header">
                            ...
                            <div id="content-title-field-buttons" class="mw-page-component-disabled">
                                                                            ...
                                                                            <a title="Chỉnh sửa trực tiếp" href="http://localhost/dacsn/C%E1%BA%A6N-B%C3%81N-CHI%E1%BA%BEC-VISON?editmode=y" class="btn   btn-outline-primary  btn-sm  btn-sm-only-icon mw-admin-go-live-now-btn mx-1">
                            ...
                            <div class="form-group" id="slug-field-holder">
                                ...
                                <input type="text" class="form-control" name="title" value="CẦN BÁN CHIẾC VISON" id="content-title-field" onkeyup="slugFromTitle();" autocomplete="">
                                    ...
                                    <span class="mw-admin-post-slug-text">
                                        ...
                                        <span class="contenteditable js-slug-base-url" data-bs-toggle="tooltip" data-title="edit" data-placement="right" contenteditable="true">CẦN-BÁN-CHIẾC-VISON</span>
                                    </span>
                                  </div>

                                <div class="d-none">
                                    <input autocomplete="off" name="url" id="edit-content-url" class="js-slug-base-url-changed edit-post-slug" type="text" value="CẦN-BÁN-CHIẾC-VISON">
                    ...
                    $(mwd).ready(function () {
                        mweditor45761676698952 = mw.Editor({
                        selector: document.getElementById('45761676698952'),
                        mode: 'div',
                        smallEditor: false,
                        onSave: function(){
                ...
                </script><textarea class="form-control" name="content" rows="10" cols="50" onSaveCallback="mw.edit_content.handle_form_submit();" autocomplete="" id="45761676698952">Do nhu cầu kh&ocirc;ng sử dụng đến, n&ecirc;n m&igrave;nh cần thanh l&yacute; gấp chiếc Vison&nbsp;&lt;div&gt;Gi&aacute;: 28,000,000 VNĐ&lt;/div&gt;&lt;div&gt;Liện hệ: 0365524897 Ngọc Dung&lt;/div&gt;&lt;div&gt;Địa chỉ: 49 Sơn Th&ocirc;ng, Phường 8, Tp.Tr&agrave; Vinh&lt;/div&gt;</textarea>
                                                                                </div>
                                                                                                </div>
...
<div id="settings-tabs">
    <div class="card style-1 mb-3 images">
        ...
        <div class="card-body pt-3">
            <div class="pictures-admin-content-type-post module module-pictures-admin " data-mw-title="Picture Gallery" id="edit-post-gallery-main" for="content" content_type="post" for-id="28" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="pictures/admin">    <script type="text/javascript">
    ...
    mw_admin_pictures_upload_browse_existing = function () {
        ...
        $(dialog.iframe).on('load', function () {
            this.contentWindow.mw.on.hashParam('select-file', function (pval) {
                after_upld(pval, 'save', 'content', '28', 'edit-post-gallery-main');

                after_upld(pval, 'done', 'content', '28', 'edit-post-gallery-main');
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f065486bc66">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f065486bc66"></div>



    <div class="admin-thumbs-holder">
                    <div class=" module module-pictures-admin-backend-sortable-pics-list " id="edit-post-gallery-main-pictures-admin-backend-sortable-pics-list" for="content" for_id="28" parent-module-id="edit-post-gallery-main" parent-module="pictures/admin" data-type="pictures/admin_backend_sortable_pics_list">
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f065488b09f');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f065488b09f',
            nav: 'dropdown',
            footer: false,
            boxed: false,
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            ...
            after_upld(url, 'Result', 'content', '28', 'edit-post-gallery-main-pictures-admin-backend-sortable-pics-list');
            after_upld(url, 'done');
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f065488b09f" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f065488b09f');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f065488b09f');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f065488b09f',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f065488b09f .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f065488b09f").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f065488b09f").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f065488b09f").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f065488b09f").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f065488b09f">
                                <div class="admin-thumb-item admin-thumb-item-53" id="admin-thumb-item-53">


                                <span class="mw-post-media-img" style="background-image: url('http://localhost/dacsn/api/image-generate-tn-request/535?saved');"></span>
                  ...
                  <span class="mdi mdi-cog image-settings settings-img tip" data-tip="Image Settings" onclick="imageConfigDialog(53)"></span>

                <span class="mdi mdi-delete image-settings remove-image tip" data-tip="Delete Image" onclick="mw.module_pictures.del('53');"></span>

                <label class="mw-ui-check">
                    <input type="checkbox" onchange="doselect()" data-url="http://localhost/dacsn/userfiles/media/default/vison.jpg" value="53"><span></span>
                </label>
                <div class="mw-post-media-img-edit">

                    <template class="image-options">

                        <div id="image-json-options-53">
                            <div class="image-json-options">
                                ...
                                <button type="button" class="btn btn-success btn-sm" onclick="mw.dialog.get(this).result(53)">Cập nhật</button>
                                </div>
                            </div>
                        </div>
                    </template>
            ...
            <div class="admin-thumb-item-uploader" id="admin-thumb-item-uploaderpic-sorter-63f065488b09f">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f065486bc66');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f065486bc66',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            var url = res && res.src ? res.src : res;
            after_upld(url, 'Result', 'content', '28', 'edit-post-gallery-main');
            after_upld(url, 'done');
            if (mw._postsImageUploader.settings.hideHeader) {
                mw._postsImageUploader.hide()
            } else {
        ...
        <div class="card style-1 mb-3 card-collapse fields js-custom-fields-card-tab">
            ...
            <div class="card-body py-0">
                <div class="collapse" id="custom-fields-settings">
                    <div class=" module module-custom-fields-admin " data-mw-title="Custom fields" content-id="28" suggest-from-related="true" list-preview="true" id="fields_for_post_28" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="custom_fields/admin">


<div class="card style-1 mb-3 ">
    <div class="card-header">
        <div class=" module module-admin-modules-info-module-title " id="fields-for-post-28-admin-modules-info-module-title" for-module="custom_fields/admin" parent-module-id="fields_for_post_28" parent-module="custom_fields/admin" data-type="admin/modules/info_module_title"><h5>
        ...
        <div class="settings-wrapper">
            ...
            <script>
                ...
                function addCustomFieldByExisting(fieldId) {
                    ...
                    make_field.rel_id = '28';
                    make_field.copy_of = fieldId;
                    //   mw.custom_fields.copy_field_by_id(fieldId, 'content', '28');
                ...
                $(document).ready(function () {
                    ...
                    mw.$('.js-cf-options').on('change', function () {
                        ...
                        if (copyof == false) {
                            ...
                            // mw.custom_fields.copy_field_by_id(copyof, 'content', '28');
                        }
                    });
                });
            ...
            <div class="module-live-edit-settings">
                <div id="custom-field-editor" class="mw-ui-box mw-ui-box-content" style="display: none">
                    ...
                    <div class="custom-field-edit">
                        ...
                        <div class="mw-admin-custom-field-edit-item-wrapper">
                            <div class="mw-admin-custom-field-edit-item mw-admin-custom-field-edit-fields_for_post_28"></div>
                        </div>
                    </div>
                </div>
                ...
                <div id="custom-fields-box">
                    ...
                    <div class=" module module-custom-fields-list " data-type="custom_fields/list" for="content" rel_id="28" list-preview="true" id="mw_custom_fields_list_preview" parent-module-id="fields_for_post_28" parent-module="custom_fields/admin"><script>
...
<script>
    ...
    $(document).ready(function (){
        ...
        <div class=" module module-help-modal-with-button " id="fields-for-post-28-help-modal-with-button" for_module="custom_fields" parent-module-id="fields_for_post_28" parent-module="custom_fields/admin" data-type="help/modal_with_button"><script>
...
<a href="javascript:;" onclick="openModalHelpReadmeMd('custom_fields');"><i class="fa fa-info-circle"></i> Cứu giúp</a>
    ...
    <div class=" module module-content-views-advanced-settings " id="main-content-edit-admin-content-views-advanced-settings" content-id="28" content-type="post" subtype="post" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/advanced_settings">    <script type="text/javascript">
        mw.lib.require('mwui_init');
    </script>
    <script type="text/javascript">
    ...
    <div class=" module module-content-views-settings-from-template " id="main-content-edit-admin-content-views-advanced-settings-content-views-settings-from-template" content-type="post" content-id="28" parent-module-id="main-content-edit-admin-content-views-advanced-settings" parent-module="content/views/advanced_settings" data-type="content/views/settings_from_template">
</div>
    ...
    <div class="card style-1 mb-3 card-collapse">
            ...
            <div class="collapse" id="advanced-settings">
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-md-8">
                        ...
                        <a class="btn btn btn-outline-primary btn-sm" href="javascript:open_edit_related_content_modal('28');">Chỉnh sửa liên quan</a>
                    </div>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-md-12 text-center text-md-left">
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="javascript:mw.copy_current_page('28');">Bản sao</a> 
                        <a class="btn btn-outline-primary btn-sm" href="javascript:mw.reset_current_page('28');">Đặt lại nội dung</a>
                                    ...
                                    <input name="position" type="hidden" value="17">
                        ...
                        <div class="col-md-12">
                            <div>
                                <small>
                                    Tôi: <span class="mw-admin-edit-post-display-id-at-value">28</span>
                                    ...
                                    <script>
                                        $(function () {
                                            ...
                                            <div class="mw-admin-edit-post-created-at" onclick="mw.adm_cont_enable_edit_of_created_at()">
                                                <small>
                                                    Được tạo ra: <span class="mw-admin-edit-post-display-created-at-value">2023-02-18 05:42:31</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-created-at-value" style="display:none" type="text" name="created_at" value="2023-02-18 05:42:31">
                                                </small>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mw-admin-edit-post-updated-at" onclick="mw.adm_cont_enable_edit_of_updated_at()">
                                                <small>
                                                    Cập nhật vào: <span class="mw-admin-edit-post-display-updated-at-value">2023-02-18 05:42:31</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-updated-at-value" style="display:none" type="text" name="updated_at" value="2023-02-18 05:42:31">
                                                </small>
                                            </div>
                                        </div>
                                                                    </div>
        ...
        <div class="alert alert-danger" role="alert">
            ...
            <a class="btn btn-outline-danger btn-sm" id="mw-admin-content-edit-inner-delete-curent-content-btn" href="javascript:mw.del_current_page('28');">Xóa nội dung</a>
...
<script>
    ...
    mw.edit_content.close_alert = function () {
        ...
        mw.$('#post-added-alert-1507593415').hide();

    };

    mw.edit_content.load_page_preview = function (element_id) {
        var element_id = element_id || 'mw-admin-content-iframe-editor';
        var parent_page = mw.$('#mw-parent-page-value-1507593415', '#main-content-edit-admin').val();
        var content_id = mw.$('#mw-content-id-value', '#main-content-edit-admin').val();
        var content_type = mw.$('#mw-content-type-value-1507593415', '#main-content-edit-admin').val()
        var subtype = mw.$('#mw-content-subtype', '#main-content-edit-admin').val();
        var subtype_value = mw.$('#mw-content-subtype-value-1507593415', '#main-content-edit-admin').val();
        var active_site_template = $('#mw-active-template-value-1507593415', '#main-content-edit-admin').val();
        var active_site_layout = $('#mw-layout-file-value-1507593415').val();
    ...
    mw.edit_content.set_category = function (id) {
        ...
        if (names.length > 0) {
            mw.$('#mw-parent-page-value-1507593415').val(names[0]).trigger("change");
        } else {
            mw.$('#mw-parent-page-value-1507593415').val(0).trigger("change");
        }
    }
...
<script>
    $(mwd).ready(function () {
        ...
        mw.edit_content.load_editor();
                // mw.edit_content.render_category_tree("1507593415");
        mw.$("#quickform-edit-content").submit(function () {
            mw.edit_content.handle_form_submit();
            return false;
        });
                mw.$(".mw-admin-go-live-now-btn").attr('content-id', 28);
                mw.$('#mw-parent-page-value-1507593415').on('change', function (e) {
        ...
        mw.$(".admin-manage-toolbar").on("mousemove", function () {
            mw.tools.removeClass(document.body, 'editorediting');
                ...
                <script>
        $(document).ready(function () {
            $('.go-live-edit-href-set').attr('href', 'http://localhost/dacsn/CẦN-BÁN-CHIẾC-VISON?editmode=y');
            $('.go-live-edit-href-set-view').attr('href', 'http://localhost/dacsn/CẦN-BÁN-CHIẾC-VISON?editmode=n');
        });
    </script>
...
<div class="col-md-4 manage-content-sidebar">
    ...
    <div class=" module module-content-views-edit-default-sidebar-variants " id="main-content-edit-admin-content-views-edit-default-sidebar-variants" content-id="28" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/edit_default_sidebar_variants">
</div>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                                ...
                                $(document).ready(function () {
                                    ...
                                    $('#mw-post-added-1507593415').on('mousedown touchstart', function (e) {
                            ...
                            <div class="mw-tag-selector mt-3" id="mw-post-added-1507593415">
                                ...
                                <div id="show-categories-tree">
                                    <div class="mw-admin-edit-page-primary-settings content-category-selector">
                                        <div class="mw-ui-field-holder">
                                            <div class="mw-ui-category-selector mw-ui-category-selector-abs mw-tree mw-tree-selector" id="mw-category-selector-1507593415">
                                                                                                    <script>
                                                        $(document).ready(function () {
                                                            loadCategoriesTree();
                                                        });
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        <small data-bs-toggle="tooltip" title="Thẻ / Nhãn cho nội dung này. Sử dụng dấu phẩy (,) để thêm nhiều thẻ"></small>
                                    ...
                                    <div class=" module module-content-views-content-tags " id="main-content-edit-admin-content-views-content-tags" content-type="post" content-id="28" parent-module-id="main-content-edit-admin" parent-module="content/edit" data-type="content/views/content_tags">
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/9fd86575cffb77cc5578a078c3b6f0edb379e3f5.blade.php ENDPATH**/ ?>