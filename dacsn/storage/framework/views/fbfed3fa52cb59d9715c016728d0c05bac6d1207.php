...
} elseif ($_instance->childHasBeenRendered('IyUmhGi')) {
    $componentId = $_instance->getRenderedChildComponentId('IyUmhGi');
    $componentTag = $_instance->getRenderedChildComponentTagName('IyUmhGi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IyUmhGi');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('IyUmhGi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="Ssi1MxJBCStCLDI6INDm" wire:initial-data='{"fingerprint":{"id":"Ssi1MxJBCStCLDI6INDm","name":"admin-posts-list","locale":"vi_VN","path":"admin\/post","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/post?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"e9dbbce1","data":{"model":"MicroweberPackages\\Post\\Models\\Post","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"3d4b156383348a180e561cebcddbb4030bfb5d781839b2c853eabbf42ff17282"}}' class="card style-1 mb-3">
...
<script>
    ...
    <select class="form-select form-select-sm" wire:model="paginate">
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/436?saved" class="rounded-full">
    </div>
    ...
    <a href="http://localhost/dacsn/admin/post/25/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('25');" class="btn btn-outline-danger btn-sm js-delete-content-btn-25">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">2 results found</span>
                </div>
...
<!-- Livewire Component wire-end:0s4UQEK2zfLmF3Lu1dzW -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/9e65728d6e21e347bb380dca85dfe56c1c41377d.blade.php ENDPATH**/ ?>