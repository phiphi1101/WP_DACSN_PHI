...
} elseif ($_instance->childHasBeenRendered('gjXuWpE')) {
    $componentId = $_instance->getRenderedChildComponentId('gjXuWpE');
    $componentTag = $_instance->getRenderedChildComponentTagName('gjXuWpE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gjXuWpE');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('gjXuWpE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/50931e6a0603688cd9d360f0f77097952d05d989.blade.php ENDPATH**/ ?>