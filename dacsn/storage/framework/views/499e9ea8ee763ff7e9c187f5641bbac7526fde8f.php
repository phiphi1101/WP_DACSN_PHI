...
} elseif ($_instance->childHasBeenRendered('pIVNfAg')) {
    $componentId = $_instance->getRenderedChildComponentId('pIVNfAg');
    $componentTag = $_instance->getRenderedChildComponentTagName('pIVNfAg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pIVNfAg');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('pIVNfAg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/d9da490bcae34d11e2f9b6a64324946a17180443.blade.php ENDPATH**/ ?>