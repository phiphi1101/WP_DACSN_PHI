...
} elseif ($_instance->childHasBeenRendered('YgyluNG')) {
    $componentId = $_instance->getRenderedChildComponentId('YgyluNG');
    $componentTag = $_instance->getRenderedChildComponentTagName('YgyluNG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YgyluNG');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('YgyluNG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<script>mw.require("files.js");</script>
        ...
        var isValid = function () {
            var valid = true;
            mw.$('[name="email"], [name="text"]', '#users_edit_63f065b549716').each(function () {
        ...
        SaveAdminUserForm2 = function () {
            ...
            mw.form.post(mw.$('#users_edit_63f065b549716'), 'http://localhost/dacsn/api/user/2', function (scopeEl) {
                if (this.error) {
        ...
        <div class="card-body pt-3">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="module-users-edit-user user-id-2" id="users_edit_63f065b549716">
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/19233d7252eb2f0511da8833bd46628b11dac44f.blade.php ENDPATH**/ ?>