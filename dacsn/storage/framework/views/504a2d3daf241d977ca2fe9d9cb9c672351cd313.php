...
} elseif ($_instance->childHasBeenRendered('0hwIEgm')) {
    $componentId = $_instance->getRenderedChildComponentId('0hwIEgm');
    $componentTag = $_instance->getRenderedChildComponentTagName('0hwIEgm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0hwIEgm');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('0hwIEgm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="form-group text-center">
    ...
    <main class="module-">
                    ...
                    <div class=" module module-admin-modules-info " id="module-admin-modules-info" history_back="true" data-type="admin/modules/info" parent-module="admin/modules/info" parent-module-id="module-admin-modules-info"><script>
...
<div class="card style-1 bg-light mb-3">
    <div class="card-header">
        <h5><i class="mdi mdi-account-multiple text-primary mr-3"></i> <strong>Quản lý người dùng</strong>
        </h5>
    </div>
    ...
    <div class="card-body pt-3" id="users-manage-body">
                ...
                <div class="form-inline">
                    <div class="form-group">
                        <div class="input-group mb-0 prepend-transparent">
                            ...
                            <input type="search" value="" name="keyword" class="form-control" aria-label="Search" placeholder="Tìm kiếm người dùng">
                        </div>
                    </div>
                    ...
                    <div class="bg-primary-opacity-1 rounded px-3 py-2 mb-4">
                        <div class="row d-flex">
                                    ...
                                    <div class="col-md-4">
                                        <div>
                                            ...
                                            <select class="selectpicker" data-style="btn-md" name="isAdmin">
                                                ...
                                                <option selected="selected"  value="0">Người sử dụng</option>
                            ...
                            <div class="col d-flex align-items-center justify-content-center">
                                ...
                                <div class="text-center">
                                    <a href="http://localhost/dacsn/admin/user" class="btn btn-outline-primary btn-sm" type="button">
                                        Reset filters
                                    </a>
                                </div>
                            </div>
        ...
        <div style="width:200px;float:right;text-align:right; margin-top:5px;margin-bottom:15px;">
            ...
            <select class="form-control" onchange="location = this.value;">
                ...
                <option disabled="disabled">Select sorting</option>

                <option  value="http://localhost/dacsn/admin/user?orderBy=created_at&orderDirection=desc&showFilter=1">Người dùng [New > Old]</option>
                <option  value="http://localhost/dacsn/admin/user?orderBy=created_at&orderDirection=asc&showFilter=1">Người dùng [Old > New]</option>
        ...
        <div class="table-responsive bg-white mw-admin-users-manage-table">
            <table class="table table-hover m-0" cellspacing="0" cellpadding="0">
                ...
                <tr id="mw-admin-user-3">
                    <td>
                        <div class="img-circle-holder img-absolute w-60">
                            <img src="http://localhost/dacsn/userfiles/modules/microweber/api/libs/mw-ui/assets/img/no-user.png">
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="text-outline-primary font-weight-bold">
                            Lợi Ngô
                                                            <br><small class="text-dark">Người sử dụng</small>
                                                    </div>
                    </td>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="http://localhost/dacsn/admin/view:modules/load_module:users/edit-user:3">Biên tập</a>
                    </td>
                </tr>


                
                <tr id="mw-admin-user-2">
                    <td>
                        <div class="img-circle-holder img-absolute w-60">
                            <img src="http://localhost/dacsn/userfiles/modules/microweber/api/libs/mw-ui/assets/img/no-user.png">
                        </div>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="http://localhost/dacsn/admin/view:modules/load_module:users/edit-user:2">Biên tập</a>
                    </td>
                </tr>


                
                <tr id="mw-admin-user-1">
                    <td>
                        <div class="img-circle-holder img-absolute w-60">
                            <img src="http://localhost/dacsn/userfiles/modules/microweber/api/libs/mw-ui/assets/img/no-user.png">
                        </div>
                    ...
                    <td>
                        <div class="text-outline-primary font-weight-bold">
                                                            ...
                                                            <br><small class="text-dark">quản trị viên</small>
                                                        </div>
                    </td>
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="http://localhost/dacsn/admin/view:modules/load_module:users/edit-user:1">Biên tập</a>
                    </td>
                </tr>
        ...
        <div class="text-right mt-3">
                            <a href="http://localhost/dacsn/admin/user?exportResults=1" class="btn btn-outline-success btn-sm">
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/5a26195f2726d98871b0129a1073cdf4fa92fbed.blade.php ENDPATH**/ ?>