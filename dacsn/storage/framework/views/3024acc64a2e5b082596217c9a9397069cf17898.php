...
} elseif ($_instance->childHasBeenRendered('ndnZfDF')) {
    $componentId = $_instance->getRenderedChildComponentId('ndnZfDF');
    $componentTag = $_instance->getRenderedChildComponentTagName('ndnZfDF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ndnZfDF');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('ndnZfDF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/eac39cda3bb1a56b22e68b7c1bfefbe17efe4de0.blade.php ENDPATH**/ ?>