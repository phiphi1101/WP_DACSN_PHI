<?php if(method_exists($contents,'count') && $contents->count() == 0): ?>
...
<?php if(isset($contents)  and !empty($contents)): ?>
    <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="collapse" id="comments-<?php print $content['id'] ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php $__currentLoopData = $content->allComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php echo $__env->make('comment::admin.comments.comment_item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\dacsn\src\MicroweberPackages\Comment/resources/views/admin/comments/partials/list.blade.php ENDPATH**/ ?>