...
} elseif ($_instance->childHasBeenRendered('ad8RXDJ')) {
    $componentId = $_instance->getRenderedChildComponentId('ad8RXDJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('ad8RXDJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ad8RXDJ');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('ad8RXDJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
    ...
    <div>
        <div id="js-page-tree-wrapper">
            ...
            <div class="js-page-tree-skeleton">
                ...
                <div class="skeleton-loading skeleton-item" style="width:130px;margin-left:50px;">
                    <div class="d-flex">
                        <div class="skeleton-icon"></div>
        ...
        <div class="module-content">
            <div class="row">
                <div class="col-md-12">
                    <div class=' module module-categories-edit-category '   id="admin-category-edit"   data-category-id="11"   data-type="categories/edit_category"   parent-module="categories/edit_category"   parent-module-id="admin-category-edit"  ><style>
    ...
    <script type="text/javascript">
        ...
        continue_editing_cat = function () {
            ...
            mw.$('#admin_edit_category_form').submit(function () {
                ...
                var catSaveUrl = 'http://localhost/dacsn/api/category/11';
        ...
        <div class="text-right">
            <div class="create-root mb-3">
                <div id="content-title-field-buttons">
                        ...
                        <a href="http://localhost/dacsn/blog/Th%E1%BB%9Di-trang-L%C3%A0m-%C4%91%E1%BA%B9p20230218052254" target="_blank" class="btn btn-link btn-sm  ">View category</a>


                        <a href="http://localhost/dacsn/admin/category/create?addsubcategory=11" class="btn btn-sm btn-outline-primary">Thêm danh mục phụ</a>  
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="admin_edit_category_form" name="admin_edit_category_form" autocomplete="off" style="">
                    ...
                    <input name="id" type="hidden" id="mw_admin_edit_cat_id" value="11">
                                ...
                                mw.$('#mw-admin-post-media-type')
                                    ...
                                    .on('show.bs.select', function () {
                                        ...
                                        $(dropdownUploader).on('FileUploaded', function (e, res) {
                                            ...
                                            after_upld(url, 'Result', 'categories', '11', 'admin-category-edit');
    ...
    mw_admin_pictures_upload_browse_existing = function () {
        ...
        $(dialog.iframe).on('load', function () {
            this.contentWindow.mw.on.hashParam('select-file', function (pval) {
                after_upld(pval, 'save', 'category', '11', 'mw-cat-pics-admin');

                after_upld(pval, 'done', 'category', '11', 'mw-cat-pics-admin');
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f060af5cba6">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f060af5cba6"></div>



    <div class="admin-thumbs-holder">
                    <div class=' module module-pictures-admin-backend-sortable-pics-list ' id='mw-cat-pics-admin-pictures-admin-backend-sortable-pics-list'  for="category"   for_id="11"   parent-module-id="mw-cat-pics-admin"   parent-module="pictures/admin"   data-type="pictures/admin_backend_sortable_pics_list"  >
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f060af61979');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f060af61979',
            nav: 'dropdown',
            footer: false,
            boxed: false,
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            ...
            after_upld(url, 'Result', 'category', '11', 'mw-cat-pics-admin-pictures-admin-backend-sortable-pics-list');
            after_upld(url, 'done');
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f060af61979" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f060af61979');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f060af61979');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f060af61979',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f060af61979 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f060af61979").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f060af61979").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f060af61979").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f060af61979").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f060af61979">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f060af5cba6');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f060af5cba6',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            var url = res && res.src ? res.src : res;
            after_upld(url, 'Result', 'category', '11', 'mw-cat-pics-admin');
            after_upld(url, 'done');
            if (mw._postsImageUploader.settings.hideHeader) {
                mw._postsImageUploader.hide()
            } else {
        ...
        doselect()
                                                    ...
                                                    <div class="col-md-12">
                                <div class=' module module-content-views-settings-from-template ' id='admin-category-edit-content-views-settings-from-template'  content-type="category"   content-id="11"   category-id="11"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="content/views/settings_from_template"  >
</div>
                            </div>
                            ...
                            <div class="collapse mt-3" id="show-more">
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mb-3">
                                                    <small><a href="http://localhost/dacsn/blog/Th%E1%BB%9Di-trang-L%C3%A0m-%C4%91%E1%BA%B9p20230218052254" target="_blank">http://localhost/dacsn/blog/Thời-trang-Làm-đẹp20230218052254</a></small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="url" value="Thời-trang-Làm-đẹp20230218052254" id="url" spellcheck="">                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                            ...
                                            <div class=' module module-categories-edit-category-subtype-settings '   category_subtype="default"   category-id="11"   id="admin_edit_category_subtype_settings"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="categories/edit_category_subtype_settings"  ></div>
                                                                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                                ...
                                <a href="javascript:mw.content.deleteCategory('11');" class="btn btn-sm btn-outline-danger"><i class="mw-icon-bin "></i>  Xóa bỏ</a>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/d0b7e645301219168529e53e9959a70554fc78fe.blade.php ENDPATH**/ ?>