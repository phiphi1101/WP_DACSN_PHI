...
} elseif ($_instance->childHasBeenRendered('U1PjSbf')) {
    $componentId = $_instance->getRenderedChildComponentId('U1PjSbf');
    $componentTag = $_instance->getRenderedChildComponentTagName('U1PjSbf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('U1PjSbf');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('U1PjSbf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/35a79e4db1ac21085e017566d556c2ef11ef0d96.blade.php ENDPATH**/ ?>