...
} elseif ($_instance->childHasBeenRendered('JNM6atd')) {
    $componentId = $_instance->getRenderedChildComponentId('JNM6atd');
    $componentTag = $_instance->getRenderedChildComponentTagName('JNM6atd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JNM6atd');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('JNM6atd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group" id="content-title-field-row">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Category name" value="" id="content-title-field" autofocus="autofocus">
                            </div>
                        </div>
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f06488320d1">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f06488320d1"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0648834de9');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f0648834de9',
            nav: 'dropdown',
            footer: false,
            boxed: false,
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f0648834de9" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f0648834de9');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f0648834de9');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f0648834de9',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0648834de9 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0648834de9").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0648834de9").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f0648834de9").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f0648834de9").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f0648834de9">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f06488320d1');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f06488320d1',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/473561a2ba72425818ffe0d55dbad6d304216612.blade.php ENDPATH**/ ?>