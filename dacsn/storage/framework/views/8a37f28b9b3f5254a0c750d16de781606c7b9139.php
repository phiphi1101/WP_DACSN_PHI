...
} elseif ($_instance->childHasBeenRendered('UHDBOhK')) {
    $componentId = $_instance->getRenderedChildComponentId('UHDBOhK');
    $componentTag = $_instance->getRenderedChildComponentTagName('UHDBOhK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UHDBOhK');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('UHDBOhK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<script>mw.require("files.js");</script>
        ...
        var isValid = function () {
            var valid = true;
            mw.$('[name="email"], [name="text"]', '#users_edit_63f065940a6af').each(function () {
        ...
        SaveAdminUserForm0 = function () {
            ...
            mw.form.post(mw.$('#users_edit_63f065940a6af'), 'http://localhost/dacsn/api/user', function (scopeEl) {
                if (this.error) {
        ...
        <div class="card-body pt-3">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="module-users-edit-user user-id-0" id="users_edit_63f065940a6af">
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/5b501542a17c4bf74d27c937fb519fbc0c717494.blade.php ENDPATH**/ ?>