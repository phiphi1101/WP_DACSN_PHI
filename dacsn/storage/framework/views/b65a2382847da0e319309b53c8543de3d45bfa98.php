...
} elseif ($_instance->childHasBeenRendered('y5qGacD')) {
    $componentId = $_instance->getRenderedChildComponentId('y5qGacD');
    $componentTag = $_instance->getRenderedChildComponentTagName('y5qGacD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('y5qGacD');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('y5qGacD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:155px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:144px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="E2Q9q2XX4wlRKE8NlRHn" wire:initial-data='{"fingerprint":{"id":"E2Q9q2XX4wlRKE8NlRHn","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"78227b02","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"4143e638575fa088bf8389b48a764b925139bcaaa204c05d422cafa3af390898"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:RqhgVtvsyuTYWMZG9fOo -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/04ce254743335c0dea7680e9bd3e5c5a73ecf855.blade.php ENDPATH**/ ?>