...
<body class="is_admin loading view-dashboard action-">
...
} elseif ($_instance->childHasBeenRendered('DfqjNsu')) {
    $componentId = $_instance->getRenderedChildComponentId('DfqjNsu');
    $componentTag = $_instance->getRenderedChildComponentTagName('DfqjNsu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DfqjNsu');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('DfqjNsu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/3290e26a5582839c99dcf45facfc964c0332d816.blade.php ENDPATH**/ ?>