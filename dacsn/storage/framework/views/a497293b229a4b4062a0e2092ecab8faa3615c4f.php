...
} elseif ($_instance->childHasBeenRendered('BUfPqf2')) {
    $componentId = $_instance->getRenderedChildComponentId('BUfPqf2');
    $componentTag = $_instance->getRenderedChildComponentTagName('BUfPqf2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BUfPqf2');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('BUfPqf2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    ...
    <div class="module-content">
        ...
        <div wire:id="BYmUWq7iBbXZV5WKMc0q" wire:initial-data='{"fingerprint":{"id":"BYmUWq7iBbXZV5WKMc0q","name":"admin-pages-list","locale":"vi_VN","path":"admin\/page","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/page?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"9276392e","data":{"model":"MicroweberPackages\\Page\\Models\\Page","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"6a8e98af346bba0e5c0e0029348a74bceec2ca289453dbe4861ca9304c2511e2"}}' class="card style-1 mb-3">
    ...
    <div class="col d-flex justify-content-md-between justify-content-center align-items-center px-0">
        ...
        <div>
                            ...
                            <a href="http://localhost/dacsn/admin/page/create" class="btn btn-link btn-sm">Thêm trang</a>
...
<!-- Livewire Component wire-end:idpZ5nP7MVnTMULIFg9e -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/eb416b7aeb523315fc8f837bbf64fbd4bacd1cf5.blade.php ENDPATH**/ ?>