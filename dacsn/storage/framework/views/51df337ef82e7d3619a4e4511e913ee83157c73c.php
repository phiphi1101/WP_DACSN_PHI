...
} elseif ($_instance->childHasBeenRendered('sAXfDY7')) {
    $componentId = $_instance->getRenderedChildComponentId('sAXfDY7');
    $componentTag = $_instance->getRenderedChildComponentTagName('sAXfDY7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sAXfDY7');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('sAXfDY7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/7efa386178e0ef168b165446343201544f2f35f4.blade.php ENDPATH**/ ?>