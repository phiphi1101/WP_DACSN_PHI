...
} elseif ($_instance->childHasBeenRendered('WKZeFIM')) {
    $componentId = $_instance->getRenderedChildComponentId('WKZeFIM');
    $componentTag = $_instance->getRenderedChildComponentTagName('WKZeFIM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WKZeFIM');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('WKZeFIM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
    ...
    <div>
        <div id="js-page-tree-wrapper">
            ...
            <div class="js-page-tree-skeleton">
                ...
                <div class="skeleton-loading skeleton-item" style="width:153px;margin-left:25px;">
                    <div class="d-flex">
                        <div class="skeleton-icon"></div>
                        <div class="skeleton-label" style="width:103px;"></div>
                    </div>
                </div>
        ...
        <div class="module-content">
            <div class="row">
                <div class="col-md-12">
                    <div class=' module module-categories-edit-category '   id="admin-category-edit"   data-category-id="10"   data-type="categories/edit_category"   parent-module="categories/edit_category"   parent-module-id="admin-category-edit"  ><style>
    ...
    <script type="text/javascript">
        ...
        continue_editing_cat = function () {
            ...
            mw.$('#admin_edit_category_form').submit(function () {
                ...
                var catSaveUrl = 'http://localhost/dacsn/api/category/10';
            ...
            <div class="create-root mb-3">
                <div id="content-title-field-buttons">
                            ...
                            mw.quick_cat_edit_create = function (id) {
                                ...
                                if (!!id) {
                                    var modalTitle = 'Chỉnh sửa danh mục';
                                } else {
                                    var modalTitle = 'Thêm thể loại';
                                }
                        ...
                        <a href="http://localhost/dacsn/blog/Th%E1%BB%9Di-trang-L%C3%A0m-%C4%91%E1%BA%B9p" target="_blank" class="btn btn-link btn-sm  ">View category</a>


                        <a href="http://localhost/dacsn/admin/category/create?addsubcategory=10" class="btn btn-sm btn-outline-primary">Thêm danh mục phụ</a>  
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="admin_edit_category_form" name="admin_edit_category_form" autocomplete="off" style="">
                    ...
                    <input name="id" type="hidden" id="mw_admin_edit_cat_id" value="10">
                    <input name="rel_type" type="hidden" value="content">
                    <input name="rel_id" type="hidden" value="2" id="rel_id">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group" id="content-title-field-row">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Category name" value="Thời trang, Làm đẹp" id="content-title-field" autofocus="autofocus">
                            </div>
                        </div>
                                ...
                                mw.$('#mw-admin-post-media-type')
                                    ...
                                    .on('show.bs.select', function () {
                                        ...
                                        $(dropdownUploader).on('FileUploaded', function (e, res) {
                                            ...
                                            after_upld(url, 'Result', 'categories', '10', 'admin-category-edit');
                        ...
                        <input name="position" type="hidden" value="3">

                        <div class="col-12">
                            <div class=' module module-pictures-admin '   data-mw-title="Picture Gallery" title="Danh mục hình ảnh"   for="categories"   for-id="10"   hideheader="true"   uploadertype="small"   id="mw-cat-pics-admin"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="pictures/admin"  >    <script type="text/javascript">
    ...
    mw_admin_pictures_upload_browse_existing = function () {
        ...
        $(dialog.iframe).on('load', function () {
            this.contentWindow.mw.on.hashParam('select-file', function (pval) {
                after_upld(pval, 'save', 'category', '10', 'mw-cat-pics-admin');

                after_upld(pval, 'done', 'category', '10', 'mw-cat-pics-admin');
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f0600aa2662">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f0600aa2662"></div>



    <div class="admin-thumbs-holder">
                    <div class=' module module-pictures-admin-backend-sortable-pics-list ' id='mw-cat-pics-admin-pictures-admin-backend-sortable-pics-list'  for="category"   for_id="10"   parent-module-id="mw-cat-pics-admin"   parent-module="pictures/admin"   data-type="pictures/admin_backend_sortable_pics_list"  >
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0600aa6fc0');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f0600aa6fc0',
            nav: 'dropdown',
            footer: false,
            boxed: false,
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            ...
            after_upld(url, 'Result', 'category', '10', 'mw-cat-pics-admin-pictures-admin-backend-sortable-pics-list');
            after_upld(url, 'done');
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f0600aa6fc0" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f0600aa6fc0');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f0600aa6fc0');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f0600aa6fc0',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f0600aa6fc0 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0600aa6fc0").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f0600aa6fc0").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f0600aa6fc0").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f0600aa6fc0").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f0600aa6fc0">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f0600aa2662');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f0600aa2662',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            var url = res && res.src ? res.src : res;
            after_upld(url, 'Result', 'category', '10', 'mw-cat-pics-admin');
            after_upld(url, 'done');
            if (mw._postsImageUploader.settings.hideHeader) {
                mw._postsImageUploader.hide()
            } else {
        ...
        doselect()
                                                    ...
                                                    <div class="col-md-12">
                                <div class=' module module-content-views-settings-from-template ' id='admin-category-edit-content-views-settings-from-template'  content-type="category"   content-id="10"   category-id="10"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="content/views/settings_from_template"  >
</div>
                            </div>
                            ...
                            <div class="collapse mt-3" id="show-more">
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mb-3">
                                                    <small><a href="http://localhost/dacsn/blog/Th%E1%BB%9Di-trang-L%C3%A0m-%C4%91%E1%BA%B9p" target="_blank">http://localhost/dacsn/blog/Thời-trang-Làm-đẹp</a></small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="url" value="Thời-trang-Làm-đẹp" id="url" spellcheck="">                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                            ...
                                            <div class=' module module-categories-edit-category-subtype-settings '   category_subtype="default"   category-id="10"   id="admin_edit_category_subtype_settings"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="categories/edit_category_subtype_settings"  ></div>
                                                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" name="category_meta_title" autocomplete="">                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" name="category_meta_keywords" autocomplete="">                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                                ...
                                <a href="javascript:mw.content.deleteCategory('10');" class="btn btn-sm btn-outline-danger"><i class="mw-icon-bin "></i>  Xóa bỏ</a>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/f62c9d18dff503e9726e23cd1f8c84436d6c99fe.blade.php ENDPATH**/ ?>