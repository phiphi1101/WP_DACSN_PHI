...
} elseif ($_instance->childHasBeenRendered('5yxNYHT')) {
    $componentId = $_instance->getRenderedChildComponentId('5yxNYHT');
    $componentTag = $_instance->getRenderedChildComponentTagName('5yxNYHT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5yxNYHT');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('5yxNYHT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:134px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:84px;"></div>
                </div>
    ...
    <div class="module-content">
        ...
        <div wire:id="G7Z1p9ynfNA85HxHykgO" wire:initial-data='{"fingerprint":{"id":"G7Z1p9ynfNA85HxHykgO","name":"admin-posts-list","locale":"vi_VN","path":"admin\/post","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/post?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"1e30dc24","data":{"model":"MicroweberPackages\\Post\\Models\\Post","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"373bec9192a7bfa5edea1a484022e47d75edc5edea087a4e4d611766dde14e2a"}}' class="card style-1 mb-3">
    ...
    <a href="http://localhost/dacsn/admin/post/25/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('25');" class="btn btn-outline-danger btn-sm js-delete-content-btn-25">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">5 results found</span>
                </div>
...
<!-- Livewire Component wire-end:4aYWIVayD4y3dy6isHBc -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/9bd251217e3a5122b3e79254223b8fa72ed16236.blade.php ENDPATH**/ ?>