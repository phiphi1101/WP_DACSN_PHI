...
} elseif ($_instance->childHasBeenRendered('nwmQAWP')) {
    $componentId = $_instance->getRenderedChildComponentId('nwmQAWP');
    $componentTag = $_instance->getRenderedChildComponentTagName('nwmQAWP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nwmQAWP');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('nwmQAWP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="in-window">
    ...
    <form method="post" class="mw_admin_edit_content_form  " action="http://localhost/dacsn/api/post" id="quickform-edit-content" autocomplete="off">
        ...
        <input type="hidden" name="subtype_value" id="mw-content-subtype-value-363462398" value="">
        <input type="hidden" name="content_type" id="mw-content-type mw-content-type-value-363462398" value="post">
        <input type="hidden" name="parent" id="mw-parent-page-value-363462398" value="0" class="">
        <input type="hidden" name="layout_file" id="mw-layout-file-value-363462398" value="inherit">
        <input type="hidden" name="active_site_template" id="mw-active-template-value-363462398" value="">
        ...
        <div class="row">
            <div class="col-md-8 manage-content-body">
                ...
                <div class="content-title-field-row card style-1 mb-3 border-0" id="content-title-field-row">
                    ...
                    $(mwd).ready(function () {
                        mweditor84781676698705 = mw.Editor({
                        selector: document.getElementById('84781676698705'),
                        mode: 'div',
                        smallEditor: false,
                        onSave: function(){
                ...
                </script><textarea class="form-control" name="content" rows="10" cols="50" onSaveCallback="mw.edit_content.handle_form_submit();" autocomplete="" id="84781676698705"></textarea>
                                                                                </div>
                                                                                                </div>
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f06451b2f62">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f06451b2f62"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f06451c475e');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f06451c475e',
            nav: 'dropdown',
            footer: false,
            boxed: false,
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f06451c475e" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f06451c475e');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f06451c475e');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f06451c475e',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f06451c475e .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f06451c475e").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f06451c475e").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f06451c475e").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f06451c475e").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f06451c475e">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f06451b2f62');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f06451b2f62',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
...
<script>
    ...
    mw.edit_content.close_alert = function () {
        ...
        mw.$('#post-added-alert-363462398').hide();

    };

    mw.edit_content.load_page_preview = function (element_id) {
        var element_id = element_id || 'mw-admin-content-iframe-editor';
        var parent_page = mw.$('#mw-parent-page-value-363462398', '#main-content-edit-admin').val();
        var content_id = mw.$('#mw-content-id-value', '#main-content-edit-admin').val();
        var content_type = mw.$('#mw-content-type-value-363462398', '#main-content-edit-admin').val()
        var subtype = mw.$('#mw-content-subtype', '#main-content-edit-admin').val();
        var subtype_value = mw.$('#mw-content-subtype-value-363462398', '#main-content-edit-admin').val();
        var active_site_template = $('#mw-active-template-value-363462398', '#main-content-edit-admin').val();
        var active_site_layout = $('#mw-layout-file-value-363462398').val();
    ...
    mw.edit_content.set_category = function (id) {
        ...
        if (names.length > 0) {
            mw.$('#mw-parent-page-value-363462398').val(names[0]).trigger("change");
        } else {
            mw.$('#mw-parent-page-value-363462398').val(0).trigger("change");
        }
    }
...
<script>
    $(mwd).ready(function () {
        ...
        mw.edit_content.load_editor();
                // mw.edit_content.render_category_tree("363462398");
        mw.$("#quickform-edit-content").submit(function () {
            mw.edit_content.handle_form_submit();
            return false;
        });
                mw.$('#mw-parent-page-value-363462398').on('change', function (e) {
                ...
                <div class="row mb-3">
                    <div class="col-12">
                                ...
                                $(document).ready(function () {
                                    ...
                                    $('#mw-post-added-363462398').on('mousedown touchstart', function (e) {
                            ...
                            <div class="mw-tag-selector mt-3" id="mw-post-added-363462398">
                                ...
                                <div id="show-categories-tree">
                                    <div class="mw-admin-edit-page-primary-settings content-category-selector">
                                        <div class="mw-ui-field-holder">
                                            <div class="mw-ui-category-selector mw-ui-category-selector-abs mw-tree mw-tree-selector" id="mw-category-selector-363462398">
                                                                                                    <script>
                                                        $(document).ready(function () {
                                                            loadCategoriesTree();
                                                        });
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/8e679c75927e958c18c25318bb65f1302f12a61b.blade.php ENDPATH**/ ?>