...
} elseif ($_instance->childHasBeenRendered('deKGlfh')) {
    $componentId = $_instance->getRenderedChildComponentId('deKGlfh');
    $componentTag = $_instance->getRenderedChildComponentTagName('deKGlfh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('deKGlfh');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('deKGlfh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:149px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="MYWCTXXCx9iLhUR4auFq" wire:initial-data='{"fingerprint":{"id":"MYWCTXXCx9iLhUR4auFq","name":"admin-pages-list","locale":"vi_VN","path":"admin\/page","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/page?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"9276392e","data":{"model":"MicroweberPackages\\Page\\Models\\Page","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"22780b8258392bc68633dd329be19381c372f927fcac759e3640f1ceca773634"}}' class="card style-1 mb-3">
...
<!-- Livewire Component wire-end:f9GEYrmYJpr5ZBZ6cCyy -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/4ded666272962693c0780988a9ec03a9b4e0ee96.blade.php ENDPATH**/ ?>