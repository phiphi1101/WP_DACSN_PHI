...
} elseif ($_instance->childHasBeenRendered('RpnAUqT')) {
    $componentId = $_instance->getRenderedChildComponentId('RpnAUqT');
    $componentTag = $_instance->getRenderedChildComponentTagName('RpnAUqT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RpnAUqT');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('RpnAUqT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:143px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:93px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:142px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:92px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:135px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:146px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:132px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="R23vlV6fqH9Re49ZT3Ey" wire:initial-data='{"fingerprint":{"id":"R23vlV6fqH9Re49ZT3Ey","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"963d05fe","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"266c9c91512cb3af4f0f98933e05ba5d7f615bd67d036675d81ac0aadda313e5"}}' class="card style-1 mb-3">
    ...
    <a href="http://localhost/dacsn/admin/shop/product/11/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('11');" class="btn btn-outline-danger btn-sm js-delete-content-btn-11">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">20 results found</span>
                </div>
...
<!-- Livewire Component wire-end:zXJKdWBIjF0JU1cqxaLB -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/cf454eefcfe72118a05296bd99a2df3ff5d0adb7.blade.php ENDPATH**/ ?>