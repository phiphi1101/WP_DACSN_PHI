...
} elseif ($_instance->childHasBeenRendered('U0L7HsC')) {
    $componentId = $_instance->getRenderedChildComponentId('U0L7HsC');
    $componentTag = $_instance->getRenderedChildComponentTagName('U0L7HsC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('U0L7HsC');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('U0L7HsC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f05fea4a222">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f05fea4a222"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f05fea4d622');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f05fea4d622',
            nav: 'dropdown',
            footer: false,
            boxed: false,
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f05fea4d622" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f05fea4d622');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f05fea4d622');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f05fea4d622',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f05fea4d622 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f05fea4d622").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f05fea4d622").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f05fea4d622").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f05fea4d622").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f05fea4d622">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f05fea4a222');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f05fea4a222',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/001b7c51bc5ec436568519d419c9e571915d8517.blade.php ENDPATH**/ ?>