...
} elseif ($_instance->childHasBeenRendered('Ttb1SIy')) {
    $componentId = $_instance->getRenderedChildComponentId('Ttb1SIy');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ttb1SIy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ttb1SIy');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('Ttb1SIy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:139px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
    ...
    <div class="module-content">
        ...
        <div wire:id="OkK5WWGpa64J2zTqs4Q8" wire:initial-data='{"fingerprint":{"id":"OkK5WWGpa64J2zTqs4Q8","name":"admin-posts-list","locale":"vi_VN","path":"admin\/post","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/post?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"206f9e11","data":{"model":"MicroweberPackages\\Post\\Models\\Post","showColumns":{"id":true,"image":true,"title":true,"author":true},"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"filters":[],"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"34e95581375904418ebe9c9efd9092bd2ab3981db3406f171a077c0f70577067"}}' class="card style-1 mb-3">
    ...
    <a href="http://localhost/dacsn/admin/post/25/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('25');" class="btn btn-outline-danger btn-sm js-delete-content-btn-25">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">4 results found</span>
                </div>
...
<!-- Livewire Component wire-end:lhoEOUPryfuVYW2glsmC -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/3248532def60a4ef21684de920a85c64d33caa9e.blade.php ENDPATH**/ ?>