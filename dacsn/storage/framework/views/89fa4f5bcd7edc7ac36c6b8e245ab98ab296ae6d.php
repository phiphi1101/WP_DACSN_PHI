...
} elseif ($_instance->childHasBeenRendered('5DSFwRm')) {
    $componentId = $_instance->getRenderedChildComponentId('5DSFwRm');
    $componentTag = $_instance->getRenderedChildComponentTagName('5DSFwRm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5DSFwRm');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('5DSFwRm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
    ...
    <div>
        <div id="js-page-tree-wrapper">
            ...
            <div class="js-page-tree-skeleton">
                ...
                <div class="skeleton-loading skeleton-item" style="width:134px;margin-left:25px;">
                    <div class="d-flex">
                        <div class="skeleton-icon"></div>
                        <div class="skeleton-label" style="width:84px;"></div>
                    </div>
                </div>
                ...
                <div class="skeleton-loading skeleton-item" style="width:151px;margin-left:50px;">
                    <div class="d-flex">
                        <div class="skeleton-icon"></div>
        ...
        <div class="module-content">
            <div class="row">
                <div class="col-md-12">
                    <div class=' module module-categories-edit-category '   id="admin-category-edit"   data-category-id="13"   data-type="categories/edit_category"   parent-module="categories/edit_category"   parent-module-id="admin-category-edit"  ><style>
    ...
    <script type="text/javascript">
        ...
        continue_editing_cat = function () {
            ...
            mw.$('#admin_edit_category_form').submit(function () {
                ...
                var catSaveUrl = 'http://localhost/dacsn/api/category/13';
        ...
        <div class="text-right">
            <div class="create-root mb-3">
                <div id="content-title-field-buttons">
                        ...
                        <a href="http://localhost/dacsn/blog/Xe-m%C3%A1y-Xe-%C4%91%E1%BA%A1p-Oto" target="_blank" class="btn btn-link btn-sm  ">View category</a>


                        <a href="http://localhost/dacsn/admin/category/create?addsubcategory=13" class="btn btn-sm btn-outline-primary">Thêm danh mục phụ</a>  
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="admin_edit_category_form" name="admin_edit_category_form" autocomplete="off" style="">
                    ...
                    <input name="id" type="hidden" id="mw_admin_edit_cat_id" value="13">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group" id="content-title-field-row">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Category name" value="Xe máy, Xe đạp, Oto" id="content-title-field" autofocus="autofocus">
                            </div>
                        </div>
                                ...
                                mw.$('#mw-admin-post-media-type')
                                    ...
                                    .on('show.bs.select', function () {
                                        ...
                                        $(dropdownUploader).on('FileUploaded', function (e, res) {
                                            ...
                                            after_upld(url, 'Result', 'categories', '13', 'admin-category-edit');
    ...
    mw_admin_pictures_upload_browse_existing = function () {
        ...
        $(dialog.iframe).on('load', function () {
            this.contentWindow.mw.on.hashParam('select-file', function (pval) {
                after_upld(pval, 'save', 'category', '13', 'mw-cat-pics-admin');

                after_upld(pval, 'done', 'category', '13', 'mw-cat-pics-admin');
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-63f064a1bd415">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_63f064a1bd415"></div>



    <div class="admin-thumbs-holder">
                    <div class=' module module-pictures-admin-backend-sortable-pics-list ' id='mw-cat-pics-admin-pictures-admin-backend-sortable-pics-list'  for="category"   for_id="13"   parent-module-id="mw-cat-pics-admin"   parent-module="pictures/admin"   data-type="pictures/admin_backend_sortable_pics_list"  >
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-63f064a1c1799');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-63f064a1c1799',
            nav: 'dropdown',
            footer: false,
            boxed: false,
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            ...
            after_upld(url, 'Result', 'category', '13', 'mw-cat-pics-admin-pictures-admin-backend-sortable-pics-list');
            after_upld(url, 'done');
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-63f064a1c1799" style="display: none">Thả ở đây</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-63f064a1c1799');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-63f064a1c1799');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-63f064a1c1799',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-63f064a1c1799 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-63f064a1c1799").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-63f064a1c1799").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-63f064a1c1799").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-63f064a1c1799").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-63f064a1c1799">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-63f064a1bd415');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_63f064a1bd415',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            var url = res && res.src ? res.src : res;
            after_upld(url, 'Result', 'category', '13', 'mw-cat-pics-admin');
            after_upld(url, 'done');
            if (mw._postsImageUploader.settings.hideHeader) {
                mw._postsImageUploader.hide()
            } else {
        ...
        doselect()
                                                    ...
                                                    <div class="col-md-12">
                                <div class=' module module-content-views-settings-from-template ' id='admin-category-edit-content-views-settings-from-template'  content-type="category"   content-id="13"   category-id="13"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="content/views/settings_from_template"  >
</div>
                            </div>
                            ...
                            <div class="collapse mt-3" id="show-more">
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="mb-3">
                                                    <small><a href="http://localhost/dacsn/blog/Xe-m%C3%A1y-Xe-%C4%91%E1%BA%A1p-Oto" target="_blank">http://localhost/dacsn/blog/Xe-máy-Xe-đạp-Oto</a></small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="url" value="Xe-máy-Xe-đạp-Oto" id="url" spellcheck="">                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                            ...
                                            <div class=' module module-categories-edit-category-subtype-settings '   category_subtype="default"   category-id="13"   id="admin_edit_category_subtype_settings"   parent-module-id="admin-category-edit"   parent-module="categories/edit_category"   data-type="categories/edit_category_subtype_settings"  ></div>
                                                                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                                ...
                                <a href="javascript:mw.content.deleteCategory('13');" class="btn btn-sm btn-outline-danger"><i class="mw-icon-bin "></i>  Xóa bỏ</a>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/885330b8e2a28fbdd6564f982928b7f7779f0c8f.blade.php ENDPATH**/ ?>