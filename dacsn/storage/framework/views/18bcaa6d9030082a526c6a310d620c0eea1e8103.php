...
} elseif ($_instance->childHasBeenRendered('pSDcH48')) {
    $componentId = $_instance->getRenderedChildComponentId('pSDcH48');
    $componentTag = $_instance->getRenderedChildComponentTagName('pSDcH48');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pSDcH48');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('pSDcH48', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
    ...
    <header class="position-sticky sticky-top bg-white admin-navigation-colorscheme">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center py-1">
                ...
                <ul class="nav">
                                            <li class="mx-1">
                            <a href="http://localhost/dacsn/icguigu9i0?editmode=n" class="btn btn-outline-success btn-rounded btn-sm-only-icon go-live-edit-href-set go-live-edit-href-set-view">
                                <i class="mdi mdi-earth"></i><span class="d-none d-md-block ml-1">Trang mạng</span>
                            </a>
                        </li>
                        <li class="mx-1">
                            <a href="http://localhost/dacsn/icguigu9i0?editmode=y" class="btn btn-primary btn-rounded btn-sm-only-icon go-live-edit-href-set">
...
<div>
    <div id="js-page-tree-wrapper">
        ...
        <div class="js-page-tree-skeleton">
            ...
            <div class="skeleton-loading skeleton-item" style="width:148px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:98px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:133px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:136px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:86px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:138px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:88px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:156px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:135px;margin-left:50px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:85px;"></div>
                </div>
            </div>
            ...
            <div class="skeleton-loading skeleton-item" style="width:150px;margin-left:25px;">
                <div class="d-flex">
                    <div class="skeleton-icon"></div>
                    <div class="skeleton-label" style="width:100px;"></div>
                </div>
            </div>
                    </div>
    ...
    <div class="module-content">
        ...
        <div wire:id="LlkrXv65qo5FzVHq7Cqo" wire:initial-data='{"fingerprint":{"id":"LlkrXv65qo5FzVHq7Cqo","name":"admin-content-list","locale":"vi_VN","path":"admin\/content","method":"GET","v":"acj"},"effects":{"listeners":["refreshContentList","refreshContentListAndDeselectAll","setFirstPageContentList","autoCompleteSelectItem","hideFilterItem","applyFilterItem","resetFilter","showTrashed","showFromCategory","showFromPage","deselectAll"],"path":"http:\/\/localhost\/dacsn\/admin\/content?paginate=10"},"serverMemo":{"children":[],"errors":[],"htmlHash":"b009525a","data":{"displayTypesViews":[],"whitelistedEmptyKeys":[],"paginate":10,"model":"MicroweberPackages\\Content\\Models\\Content","filters":[],"showColumns":{"id":true,"image":true,"title":true,"author":true},"showFilters":[],"checked":[],"selectAll":false,"displayType":"card","page":1,"paginators":{"page":1},"appliedFilters":[]},"dataMeta":[],"checksum":"42c0823a7b00f17e10fa868e77645e8bdb264a63ee74c3a45f23a4553b041652"}}' class="card style-1 mb-3">
...
<script>
    ...
    <a href="http://localhost/dacsn/admin/post/25/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="21" id="products-21" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-21" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/264?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/21/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/riding-at-your-favourite-destination">
        <small class="text-muted">http://localhost/dacsn/riding-at-your-favourite-destination</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/21/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/21/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="20" id="products-20" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-20" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/265?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/20/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            Around the world
        </h5>
    </a>
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/around-the-world">
        <small class="text-muted">http://localhost/dacsn/around-the-world</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/20/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/20/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="19" id="products-19" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-19" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/266?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/19/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/unforgettable-summer-vibes">
        <small class="text-muted">http://localhost/dacsn/unforgettable-summer-vibes</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/19/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/19/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="18" id="products-18" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-18" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/267?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/18/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            Travel in the west
        </h5>
    </a>
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/travel-in-the-west">
        <small class="text-muted">http://localhost/dacsn/travel-in-the-west</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/18/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/18/edit" class="btn btn-outline-success btn-sm">Live Edit</a>

        <a href="javascript:mw.admin.content.delete('18');" class="btn btn-outline-danger btn-sm js-delete-content-btn-18">Delete</a>
        </div>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="17" id="products-17" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-17" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/268?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/17/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/discovery-incommode-earnestly-no-he-commanded">
        <small class="text-muted">http://localhost/dacsn/discovery-incommode-earnestly-no-he-commanded</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/post/17/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/post/17/edit" class="btn btn-outline-success btn-sm">Live Edit</a>

        <a href="javascript:mw.admin.content.delete('17');" class="btn btn-outline-danger btn-sm js-delete-content-btn-17">Delete</a>
        </div>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="9" id="products-9" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-9" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/269?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/9/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            Modern Golder Watch
        </h5>
    </a>
            ...
            <div class="text-muted">
            <a href="http://localhost/dacsn/admin/page/8/edit" class="btn btn-link p-0 text-muted mw-products-breadcrumb">Shop</a>
        </div>
            ...
            <span class="manage-post-item-cats-inline-list">
                    ...
                    <a onclick="livewire.emit('selectCategoryFromTableList', 7);return false;" href="?filters%5Bcategory%5D=7&amp;showFilters%5Bcategory%5D=1" class="btn btn-link btn-sm p-0">
                        Others
                     </a>

                    
                                         </span>
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/modern-golder-watch">
        <small class="text-muted">http://localhost/dacsn/modern-golder-watch</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/shop/product/9/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/shop/product/9/edit" class="btn btn-outline-success btn-sm">Live Edit</a>

        <a href="javascript:mw.admin.content.delete('9');" class="btn btn-outline-danger btn-sm js-delete-content-btn-9">Delete</a>
        </div>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="10" id="products-10" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-10" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/270?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/10/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            JBL speaker WI-FI
        </h5>
    </a>
            ...
            <span class="manage-post-item-cats-inline-list">
                    ...
                    <a onclick="livewire.emit('selectCategoryFromTableList', 5);return false;" href="?filters%5Bcategory%5D=5&amp;showFilters%5Bcategory%5D=1" class="btn btn-link btn-sm p-0">
                        Sound Systems
                     </a>
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/jbl-speaker-wi-fi">
        <small class="text-muted">http://localhost/dacsn/jbl-speaker-wi-fi</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/shop/product/10/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/shop/product/10/edit" class="btn btn-outline-success btn-sm">Live Edit</a>

        <a href="javascript:mw.admin.content.delete('10');" class="btn btn-outline-danger btn-sm js-delete-content-btn-10">Delete</a>
        </div>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="11" id="products-11" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-11" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/271?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/11/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            Apple Computer
        </h5>
    </a>
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/apple-computer">
        <small class="text-muted">http://localhost/dacsn/apple-computer</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/shop/product/11/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/shop/product/11/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <div class="card card-product-holder mb-2 post-has-image-true manage-post-item">
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center flex-lg-box">
                    ...
                    <div class="col text-center manage-post-item-col-1" style="max-width: 40px;">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="12" id="products-12" class="js-select-posts-for-action custom-control-input" wire:model="checked">
                            <label for="products-12" class="custom-control-label"></label>
                        </div>
                        <span class="btn btn-link text-muted px-0 js-move mw_admin_posts_sortable_handle" onmousedown="mw.manage_content_sort()">
                            <i class="mdi mdi-cursor-move"></i>
                        </span>
        ...
        <img src="http://localhost/dacsn/api/image-generate-tn-request/272?saved" class="rounded-full">
    </div>
    ...
    <a target="_self" href="http://localhost/dacsn/admin/page/12/edit" class="btn btn-link p-0">
        <h5 class="text-dark text-break-line-1 mb-0 manage-post-item-title">
            3D Sound Speaker
        </h5>
    </a>
        ...
        <a class="manage-post-item-link-small mw-medium d-none d-lg-block" target="_self" href="http://localhost/dacsn/3d-sound-speaker">
        <small class="text-muted">http://localhost/dacsn/3d-sound-speaker</small>
    </a>
</div>
                        <div class="manage-post-item-links mt-3">

    <a href="http://localhost/dacsn/admin/shop/product/12/edit" class="btn btn-outline-primary btn-sm">Edit</a>
    <a href="http://localhost/dacsn/admin/shop/product/12/edit" class="btn btn-outline-success btn-sm">Live Edit</a>
        ...
        <a href="javascript:mw.admin.content.delete('12');" class="btn btn-outline-danger btn-sm js-delete-content-btn-12">Delete</a>
            ...
            <div class="d-flex justify-content-center">
                ...
                <div style="width: 100%">
                    <span class="text-muted">19 results found</span>
                </div>
...
<!-- Livewire Component wire-end:nk9OLdUR6jN4gVucTMK9 -->
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\dacsn\storage\framework\views/f3af243ab7eb4de6ae8529548ae1856bd043f96f.blade.php ENDPATH**/ ?>