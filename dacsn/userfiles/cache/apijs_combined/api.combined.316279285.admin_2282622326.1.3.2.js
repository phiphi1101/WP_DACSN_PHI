(function () {
    ...
    mw.settings = {
        ...
        debug: true,
        basic_mode: false,
        site_url: 'http://localhost/dacsn/',
        template_url: 'http://localhost/dacsn/userfiles/templates/new-world/',
        modules_url: 'http://localhost/dacsn/userfiles/modules/',
        includes_url: 'http://localhost/dacsn/userfiles/modules/microweber/',
        upload_url: 'http://localhost/dacsn/api/upload/',
        api_url: 'http://localhost/dacsn/api/',
        libs_url: 'http://localhost/dacsn/userfiles/modules/microweber/api/libs/',
        api_html: 'http://localhost/dacsn/api_html/',
        ...
        edit_area_placeholder: '<div class="empty-element-edit-area empty-element ui-state-highlight ui-sortable-placeholder"><span>Vui lòng kéo các mục vào đây</span></div>',
        empty_column_placeholder: '<div id="_ID_" class="empty-element empty-element-column">Vui lòng kéo các mục vào đây</div>',
        handles: {
            item: "<div title='Bấm để chọn mục này.' class='mw_master_handle' id='items_handle'></div>"
        },
        sorthandle_delete_confirmation_text: "Bạn có chắc chắn muốn xóa phần tử này không?"
    }
    ...
    mw.msg = mw._lang = {
        ...
        contentunpublished: "Nội dung chưa được xuất bản",
        contentpublished: "Nội dung được xuất bản",
        save: "Lưu lại",
        saving: "Tiết kiệm",
        saved: "Đã lưu",
        settings: "Cài đặt",
        ...
        remove: "Di dời",
        close: "Đóng",
        to_delete_comment: "Bạn có chắc là bạn muốn xoá bình luận này không",
        del: "Bạn có chắc chắn muốn xóa cái này không?",
        save_and_continue: "Lưu &amp;amp; Tiếp tục",
        before_leave: "Rời khỏi mà không lưu",
        session_expired: "Phiên của bạn đã hết hạn",
        login_to_continue: "Làm ơn đăng nhập để tiếp tục",
        more: "Hơn",
        templateSettingsHidden: "Cài đặt mẫu",
        less: "Ít hơn",
        product_added: "Sản phẩm của bạn đã được thêm vào giỏ hàng",
        no_results_for: "Không có kết quả cho",
        switch_to_modules: 'Chuyển sang Mô-đun',
    ...
    const Ziggy = {"url":"http:\/\/localhost\/dacsn","port":null,"defaults":{},"routes":{"api.content.get_admin_js_tree_json":{"uri":"api\/content\/get_admin_js_tree_json","methods":["GET","HEAD"]},"api.content.store":{"uri":"api\/content","methods":["POST"]},"api.content.save_edit":{"uri":"api\/save_edit","methods":["POST"]},"api.content.set_published":{"uri":"api\/content\/set_published","methods":["POST"]},"api.content.set_unpublished":{"uri":"api\/content\/set_unpublished","methods":["POST"]},"api.content.reorder":{"uri":"api\/content\/reorder","methods":["POST"]},"api.content.reset_edit":{"uri":"api\/content\/reset_edit","methods":["POST"]},"api.content.reset_modules_settings":{"uri":"api\/content\/reset_modules_settings","methods":["POST"]},"api.content.bulk_assign":{"uri":"api\/content\/bulk_assign","methods":["POST"]},"api.content.copy":{"uri":"api\/content\/copy","methods":["POST"]},"api.content.related.add":{"uri":"api\/content\/related_content\/add","methods":["POST"]},"api.content.related.remove":{"uri":"api\/content\/related_content\/remove","methods":["POST"]},"api.content.related.reorder":{"uri":"api\/content\/related_content\/reorder","methods":["POST"]},"api.content.redirect_to_content":{"uri":"api\/content\/redirect_to_content","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.content.delete":{"uri":"api\/content\/delete","methods":["POST"]},"api.content.get_link_admin":{"uri":"api\/content\/get_link_admin","methods":["GET","HEAD"]},"admin.content.index":{"uri":"admin\/content","methods":["GET","HEAD"]},"admin.content.create":{"uri":"admin\/content\/create","methods":["GET","HEAD"]},"admin.content.store":{"uri":"admin\/content","methods":["POST"]},"admin.content.edit":{"uri":"admin\/content\/{content}\/edit","methods":["GET","HEAD"]},"admin.content.update":{"uri":"admin\/content\/{content}","methods":["PUT","PATCH"]},"admin.content.destroy":{"uri":"admin\/content\/{content}","methods":["DELETE"]},"admin.category.index":{"uri":"admin\/category","methods":["GET","HEAD"]},"admin.category.create":{"uri":"admin\/category\/create","methods":["GET","HEAD"]},"admin.category.store":{"uri":"admin\/category","methods":["POST"]},"admin.category.show":{"uri":"admin\/category\/{category}","methods":["GET","HEAD"]},"admin.category.edit":{"uri":"admin\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.category.update":{"uri":"admin\/category\/{category}","methods":["PUT","PATCH"]},"admin.category.destroy":{"uri":"admin\/category\/{category}","methods":["DELETE"]},"admin.shop.category.index":{"uri":"admin\/shop\/category","methods":["GET","HEAD"]},"admin.shop.category.create":{"uri":"admin\/shop\/category\/create","methods":["GET","HEAD"]},"admin.shop.category.store":{"uri":"admin\/shop\/category","methods":["POST"]},"admin.shop.category.show":{"uri":"admin\/shop\/category\/{category}","methods":["GET","HEAD"]},"admin.shop.category.edit":{"uri":"admin\/shop\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.shop.category.update":{"uri":"admin\/shop\/category\/{category}","methods":["PUT","PATCH"]},"admin.shop.category.destroy":{"uri":"admin\/shop\/category\/{category}","methods":["DELETE"]},"api.":{"uri":"api\/offers_get_by_product_id","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.category.delete":{"uri":"api\/category\/delete\/{id}","methods":["DELETE"]},"api.category.delete-bulk":{"uri":"api\/category\/delete-bulk","methods":["DELETE"]},"api.category.index":{"uri":"api\/category","methods":["GET","HEAD"]},"api.category.store":{"uri":"api\/category","methods":["POST"]},"api.category.show":{"uri":"api\/category\/{category}","methods":["GET","HEAD"]},"api.category.update":{"uri":"api\/category\/{category}","methods":["PUT","PATCH"]},"api.category.destroy":{"uri":"api\/category\/{category}","methods":["DELETE"]},"api.file-manager.list":{"uri":"api\/file-manager\/list","methods":["GET","HEAD"]},"api.file-manager.delete":{"uri":"api\/file-manager\/file","methods":["DELETE"]},"api.file-manager.create-folder":{"uri":"api\/file-manager\/create-folder","methods":["POST"]},"admin.blog.filter.get-custom-fields-table":{"uri":"admin\/blog\/filter\/get-custom-fields-table","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.user.index":{"uri":"admin\/user","methods":["GET","HEAD"]},"admin.user.store":{"uri":"admin\/user","methods":["POST"]},"admin.user.update":{"uri":"admin\/user\/{user}","methods":["PUT","PATCH"]},"admin.user.destroy":{"uri":"admin\/user\/{user}","methods":["DELETE"]},"logout":{"uri":"logout","methods":["GET","HEAD"]},"logout.submit":{"uri":"logout","methods":["POST"]},"verification.verify":{"uri":"email\/verify\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.resend":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.send":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["POST"]},"password.request":{"uri":"forgot-password","methods":["GET","HEAD"]},"password.email":{"uri":"forgot-password","methods":["POST"]},"password.reset":{"uri":"reset-password\/{token}","methods":["GET","HEAD"]},"password.update":{"uri":"reset-password","methods":["POST"]},"api.users.export_my_data":{"uri":"api\/users\/export_my_data","methods":["GET","HEAD"]},"admin.login":{"uri":"admin\/login","methods":["GET","HEAD"]},"api.user.login":{"uri":"api\/user\/login","methods":["POST"]},"api.user.logout":{"uri":"api\/user\/logout","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.user.register":{"uri":"api\/user\/register","methods":["POST"]},"api.user.password.email":{"uri":"api\/user\/forgot-password","methods":["POST"]},"api.user.password.update":{"uri":"api\/user\/reset-password","methods":["POST"]},"api.user.profile.update":{"uri":"api\/user\/profile-update","methods":["POST"]},"api.api.logout":{"uri":"api\/logout","methods":["GET","HEAD"]},"api.user.index":{"uri":"api\/user","methods":["GET","HEAD"]},"api.user.store":{"uri":"api\/user","methods":["POST"]},"api.user.show":{"uri":"api\/user\/{user}","methods":["GET","HEAD"]},"api.user.update":{"uri":"api\/user\/{user}","methods":["PUT","PATCH"]},"api.user.destroy":{"uri":"api\/user\/{user}","methods":["DELETE"]},"livewire.message":{"uri":"livewire\/message\/{name}","methods":["POST"]},"livewire.upload-file":{"uri":"livewire\/upload-file","methods":["POST"]},"livewire.preview-file":{"uri":"livewire\/preview-file\/{filename}","methods":["GET","HEAD"]},"admin.language.save":{"uri":"admin\/language\/save","methods":["POST"]},"admin.language.import":{"uri":"admin\/language\/import","methods":["POST"]},"admin.language.export":{"uri":"admin\/language\/export","methods":["POST"]},"admin.language.send_to_us":{"uri":"admin\/language\/send_to_us","methods":["POST"]},"admin.language.import_missing_translations":{"uri":"admin\/language\/import_missing_translations","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.page.index":{"uri":"api\/page","methods":["GET","HEAD"]},"api.page.store":{"uri":"api\/page","methods":["POST"]},"api.page.show":{"uri":"api\/page\/{page}","methods":["GET","HEAD"]},"api.page.update":{"uri":"api\/page\/{page}","methods":["PUT","PATCH"]},"api.page.destroy":{"uri":"api\/page\/{page}","methods":["DELETE"]},"admin.page.index":{"uri":"admin\/page","methods":["GET","HEAD"]},"admin.page.create":{"uri":"admin\/page\/create","methods":["GET","HEAD"]},"admin.page.store":{"uri":"admin\/page","methods":["POST"]},"admin.page.edit":{"uri":"admin\/page\/{page}\/edit","methods":["GET","HEAD"]},"admin.page.update":{"uri":"admin\/page\/{page}","methods":["PUT","PATCH"]},"admin.page.destroy":{"uri":"admin\/page\/{page}","methods":["DELETE"]},"api.menu.add.content":{"uri":"api\/menu\/add\/content","methods":["POST"]},"api.menu.delete":{"uri":"api\/menu\/delete","methods":["POST"]},"api.menu.create":{"uri":"api\/menu\/create","methods":["POST"]},"api.menu.item.save":{"uri":"api\/menu\/item\/save","methods":["POST"]},"api.menu.item.edit":{"uri":"api\/menu\/item\/edit","methods":["POST"]},"api.menu.item.delete":{"uri":"api\/menu\/item\/delete\/{id}","methods":["POST"]},"api.menu.item.reorder":{"uri":"api\/menu\/item\/reorder","methods":["POST"]},"api.v2.menu.index":{"uri":"api\/v2\/menu","methods":["GET","HEAD"]},"api.v2.menu.store":{"uri":"api\/v2\/menu","methods":["POST"]},"api.v2.menu.show":{"uri":"api\/v2\/menu\/{menu}","methods":["GET","HEAD"]},"api.v2.menu.update":{"uri":"api\/v2\/menu\/{menu}","methods":["PUT","PATCH"]},"api.v2.menu.destroy":{"uri":"api\/v2\/menu\/{menu}","methods":["DELETE"]},"admin.product.index":{"uri":"admin\/shop\/product","methods":["GET","HEAD"]},"admin.product.create":{"uri":"admin\/shop\/product\/create","methods":["GET","HEAD"]},"admin.product.store":{"uri":"admin\/shop\/product","methods":["POST"]},"admin.product.edit":{"uri":"admin\/shop\/product\/{product}\/edit","methods":["GET","HEAD"]},"admin.product.update":{"uri":"admin\/shop\/product\/{product}","methods":["PUT","PATCH"]},"admin.product.destroy":{"uri":"admin\/shop\/product\/{product}","methods":["DELETE"]},"admin.shop.dashboard":{"uri":"admin\/shop\/dashboard","methods":["GET","HEAD"]},"api.product.quick-view":{"uri":"api\/product\/quick-view","methods":["GET","HEAD"]},"api.product.index":{"uri":"api\/product","methods":["GET","HEAD"]},"api.product.store":{"uri":"api\/product","methods":["POST"]},"api.product.show":{"uri":"api\/product\/{product}","methods":["GET","HEAD"]},"api.product.update":{"uri":"api\/product\/{product}","methods":["PUT","PATCH"]},"api.product.destroy":{"uri":"api\/product\/{product}","methods":["DELETE"]},"api.product_variant.index":{"uri":"api\/product_variant","methods":["GET","HEAD"]},"api.product_variant.store":{"uri":"api\/product_variant","methods":["POST"]},"api.product_variant.show":{"uri":"api\/product_variant\/{product_variant}","methods":["GET","HEAD"]},"api.product_variant.update":{"uri":"api\/product_variant\/{product_variant}","methods":["PUT","PATCH"]},"api.product_variant.destroy":{"uri":"api\/product_variant\/{product_variant}","methods":["DELETE"]},"api.post.index":{"uri":"api\/post","methods":["GET","HEAD"]},"api.post.store":{"uri":"api\/post","methods":["POST"]},"api.post.show":{"uri":"api\/post\/{post}","methods":["GET","HEAD"]},"api.post.update":{"uri":"api\/post\/{post}","methods":["PUT","PATCH"]},"api.post.destroy":{"uri":"api\/post\/{post}","methods":["DELETE"]},"admin.post.index":{"uri":"admin\/post","methods":["GET","HEAD"]},"admin.post.create":{"uri":"admin\/post\/create","methods":["GET","HEAD"]},"api.comment.post":{"uri":"admin\/post","methods":["POST"]},"admin.post.edit":{"uri":"admin\/post\/{post}\/edit","methods":["GET","HEAD"]},"admin.post.update":{"uri":"admin\/post\/{post}","methods":["PUT","PATCH"]},"admin.post.destroy":{"uri":"admin\/post\/{post}","methods":["DELETE"]},"api.template.change":{"uri":"api\/template\/change","methods":["GET","HEAD"]},"api.template.compile_admin_css":{"uri":"api\/template\/compile_admin_css","methods":["GET","HEAD"]},"api.template.compile_admin_live_edit_css":{"uri":"api\/template\/compile_admin_live_edit_css","methods":["GET","HEAD"]},"api.template.get_admin_css_url":{"uri":"api\/template\/get_admin_css_url","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet":{"uri":"api\/template\/reset_admin_stylesheet","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet_colors":{"uri":"api\/template\/reset_admin_stylesheet_colors","methods":["GET","HEAD"]},"api.live_edit.":{"uri":"api\/live-edit\/modules-list","methods":["GET","HEAD"]},"admin.order.abandoned":{"uri":"admin\/order\/abandoned","methods":["GET","HEAD"]},"admin.order.index":{"uri":"admin\/order","methods":["GET","HEAD"]},"admin.order.show":{"uri":"admin\/order\/{order}","methods":["GET","HEAD"]},"api.order.index":{"uri":"api\/order","methods":["GET","HEAD"]},"api.order.store":{"uri":"api\/order","methods":["POST"]},"api.order.show":{"uri":"api\/order\/{order}","methods":["GET","HEAD"]},"api.order.update":{"uri":"api\/order\/{order}","methods":["PUT","PATCH"]},"api.order.destroy":{"uri":"api\/order\/{order}","methods":["DELETE"]},"checkout.cart":{"uri":"cart","methods":["GET","HEAD"]},"checkout.contact_information":{"uri":"contact-information","methods":["GET","HEAD"]},"checkout.contact_information_save":{"uri":"contact-information-save","methods":["POST"]},"checkout.shipping_method":{"uri":"shipping-method","methods":["GET","HEAD"]},"checkout.shipping_method_change":{"uri":"shipping-method-change","methods":["POST"]},"checkout.shipping_method_save":{"uri":"shipping-method-save","methods":["POST"]},"checkout.payment_method":{"uri":"payment-method","methods":["GET","HEAD"]},"checkout.payment_method_change":{"uri":"payment-method-change","methods":["POST"]},"checkout.payment_method_save":{"uri":"payment-method-save","methods":["POST"]},"checkout.login":{"uri":"checkout\/login","methods":["GET","HEAD"]},"checkout.forgot_password":{"uri":"checkout\/forgot-password","methods":["GET","HEAD"]},"checkout.register":{"uri":"checkout\/register","methods":["GET","HEAD"]},"checkout.finish":{"uri":"checkout\/finish\/{id}","methods":["GET","HEAD"]},"api.checkout.":{"uri":"api\/checkout\/validate","methods":["POST"]},"shop.shipping.set_provider":{"uri":"api\/shop\/shipping\/set_provider","methods":["GET","POST","HEAD"]},"api.offer.store":{"uri":"api\/offer_save","methods":["POST"]},"api.offer.delete":{"uri":"api\/offer_delete","methods":["POST"]},"api.offer.get_all":{"uri":"api\/offers_get_all","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.post.form":{"uri":"api\/post_form","methods":["POST"]},"api.option.save":{"uri":"api\/save_option","methods":["POST"]},"admin.backup.restore":{"uri":"admin\/backup\/restore","methods":["GET","HEAD"]},"admin.backup.start":{"uri":"admin\/backup\/start","methods":["GET","HEAD"]},"admin.backup.download":{"uri":"admin\/backup\/download","methods":["GET","HEAD"]},"admin.backup.generate-session-id":{"uri":"admin\/backup\/generate-session-id","methods":["GET","HEAD"]},"admin.backup.upload":{"uri":"admin\/backup\/upload","methods":["POST"]},"admin.backup.delete":{"uri":"admin\/backup\/delete","methods":["POST"]},"admin.backup.language.export":{"uri":"admin\/backup\/language\/export","methods":["POST"]},"admin.backup.language.upload":{"uri":"admin\/backup\/language\/upload","methods":["POST"]},"admin.customers.delete":{"uri":"admin\/customers\/delete","methods":["POST"]},"admin.customers.index":{"uri":"admin\/customers","methods":["GET","HEAD"]},"admin.customers.create":{"uri":"admin\/customers\/create","methods":["GET","HEAD"]},"admin.customers.store":{"uri":"admin\/customers","methods":["POST"]},"admin.customers.show":{"uri":"admin\/customers\/{customer}","methods":["GET","HEAD"]},"admin.customers.edit":{"uri":"admin\/customers\/{customer}\/edit","methods":["GET","HEAD"]},"admin.customers.update":{"uri":"admin\/customers\/{customer}","methods":["PUT","PATCH"]},"admin.customers.destroy":{"uri":"admin\/customers\/{customer}","methods":["DELETE"]},"admin.notification.read":{"uri":"admin\/notification\/read","methods":["POST"]},"admin.notification.reset":{"uri":"admin\/notification\/reset","methods":["POST"]},"admin.notification.delete":{"uri":"admin\/notification\/delete","methods":["POST"]},"admin.notification.test_mail":{"uri":"admin\/notification\/test_mail","methods":["POST"]},"admin.notification.index":{"uri":"admin\/notification","methods":["GET","HEAD"]},"api.comment.admin.edit":{"uri":"admin\/edit","methods":["POST"]},"admin.comment.comment.index":{"uri":"admin\/comment","methods":["GET","HEAD"]},"api.multilanguage.geolocaiton_test":{"uri":"api\/multilanguage\/geolocaiton_test","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.multilanguage.change_language":{"uri":"api\/multilanguage\/change_language","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.multilanguage.index":{"uri":"admin\/multilanguage","methods":["GET","HEAD"]},"debugbar.openhandler":{"uri":"_debugbar\/open","methods":["GET","HEAD"]},"debugbar.clockwork":{"uri":"_debugbar\/clockwork\/{id}","methods":["GET","HEAD"]},"debugbar.assets.css":{"uri":"_debugbar\/assets\/stylesheets","methods":["GET","HEAD"]},"debugbar.assets.js":{"uri":"_debugbar\/assets\/javascript","methods":["GET","HEAD"]},"debugbar.cache.delete":{"uri":"_debugbar\/cache\/{key}\/{tags?}","methods":["DELETE"]},"standalone-updater.about-new-version":{"uri":"admin\/standalone-updater\/about-new-version","methods":["GET","HEAD"]},"api.standalone-updater.delete-temp":{"uri":"api\/standalone-updater\/delete-temp","methods":["GET","HEAD"]},"api.standalone-updater.update-now":{"uri":"api\/standalone-updater\/update-now","methods":["POST"]},"api.standalone-updater.remove-dashboard-notice":{"uri":"api\/standalone-updater\/remove-dashboard-notice","methods":["GET","HEAD"]},"api.coupon_apply":{"uri":"api\/coupon_apply","methods":["POST"]},"api.coupons_delete_session":{"uri":"api\/coupons_delete_session","methods":["POST"]},"api.coupons_save_coupon":{"uri":"api\/coupons_save_coupon","methods":["POST"]},"api.coupon_delete":{"uri":"api\/coupon_delete","methods":["POST"]},"admin.import-export-tool.upload-feed":{"uri":"admin\/import-export-tool\/upload-feed","methods":["POST"]},"admin.import-export-tool.import-wizard":{"uri":"admin\/import-export-tool\/import-wizard","methods":["GET","HEAD"]},"admin.import-export-tool.export-wizard":{"uri":"admin\/import-export-tool\/export-wizard","methods":["GET","HEAD"]},"admin.import-export-tool.export-wizard-file":{"uri":"admin\/import-export-tool\/export-wizard\/file\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.delete-wizard-file":{"uri":"admin\/import-export-tool\/delete-wizard\/file\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.index":{"uri":"admin\/import-export-tool\/index","methods":["GET","HEAD"]},"admin.import-export-tool.install":{"uri":"admin\/import-export-tool\/install","methods":["GET","HEAD"]},"admin.import-export-tool.import":{"uri":"admin\/import-export-tool\/import\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-start":{"uri":"admin\/import-export-tool\/import-start\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-delete":{"uri":"admin\/import-export-tool\/import-delete\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.index-exports":{"uri":"admin\/import-export-tool\/index-exports","methods":["GET","HEAD"]},"api.save_mail_template":{"uri":"api\/save_mail_template","methods":["POST"]},"api.delete_mail_template":{"uri":"api\/delete_mail_template","methods":["POST"]},"admin.shop.filter.get-custom-fields-table":{"uri":"admin\/shop\/filter\/get-custom-fields-table","methods":["POST"]},"adminadmin.index":{"uri":"admin","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"editor_tools":{"uri":"editor_tools\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"adminadmin.all":{"uri":"admin\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"apijs":{"uri":"apijs\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"login":{"uri":"login","methods":["GET","HEAD"]},"csrf":{"uri":"csrf","methods":["POST"]},"module":{"uri":"module\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api":{"uri":"api_nosession\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api_html":{"uri":"api_html\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"home":{"uri":"\/","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"robots":{"uri":"robots.txt","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"sitemap.index":{"uri":"sitemap.xml","methods":["GET","HEAD"]},"sitemap.categories":{"uri":"sitemap.xml\/categories","methods":["GET","HEAD"]},"sitemap.tags":{"uri":"sitemap.xml\/tags","methods":["GET","HEAD"]},"sitemap.products":{"uri":"sitemap.xml\/products","methods":["GET","HEAD"]},"sitemap.posts":{"uri":"sitemap.xml\/posts","methods":["GET","HEAD"]},"sitemap.pages":{"uri":"sitemap.xml\/pages","methods":["GET","HEAD"]},"rss.index":{"uri":"rss","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.products":{"uri":"rss-products","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.posts":{"uri":"rss-posts","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"all":{"uri":"{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"passport.token":{"uri":"oauth\/token","methods":["POST"]},"passport.token.refresh":{"uri":"oauth\/token\/refresh","methods":["POST"]},"passport.authorizations.authorize":{"uri":"oauth\/authorize","methods":["GET","HEAD"]},"passport.authorizations.approve":{"uri":"oauth\/authorize","methods":["POST"]},"passport.authorizations.deny":{"uri":"oauth\/authorize","methods":["DELETE"]},"passport.tokens.index":{"uri":"oauth\/tokens","methods":["GET","HEAD"]},"passport.tokens.destroy":{"uri":"oauth\/tokens\/{token_id}","methods":["DELETE"]},"passport.clients.index":{"uri":"oauth\/clients","methods":["GET","HEAD"]},"passport.clients.store":{"uri":"oauth\/clients","methods":["POST"]},"passport.clients.update":{"uri":"oauth\/clients\/{client_id}","methods":["PUT"]},"passport.clients.destroy":{"uri":"oauth\/clients\/{client_id}","methods":["DELETE"]},"passport.scopes.index":{"uri":"oauth\/scopes","methods":["GET","HEAD"]},"passport.personal.tokens.index":{"uri":"oauth\/personal-access-tokens","methods":["GET","HEAD"]},"passport.personal.tokens.store":{"uri":"oauth\/personal-access-tokens","methods":["POST"]},"passport.personal.tokens.destroy":{"uri":"oauth\/personal-access-tokens\/{token_id}","methods":["DELETE"]}}};
...
mw.askusertostay = false;
  ...
  if (top === self){
    window.onbeforeunload = function() {
      if(mw.askusertostay){
        mw.notification.warning("Bạn có các thay đổi chưa lưu!");
        return "Bạn có các thay đổi chưa lưu!";
      }
    }
  }

  warnOnLeave = function(){
     mw.tools.confirm("Bạn có các thay đổi chưa lưu! Bạn có chắc không?");
  };
  ...
  mw.require = function(url, inHead, key) {
    ...
    var t = url.split('.').pop();
    url = url.contains('//') ? url : (t !== "css" ? "http://localhost/dacsn/userfiles/modules/microweber/api/" + url  :  "http://localhost/dacsn/userfiles/modules/microweber/css/" + url);
...
mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/jquery.js");



mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/tools.js");
mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/tools/cookie.js");



mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/forms.js");

mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/url.js");

mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/events.js");

//mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/upgrades.js");
mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/session.js");

mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/shop.js");

mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/common.js");

mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/components.js");

mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/dialog.js");
mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/instruments.js");
mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/forms.js");
mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/fonts.js");

//mw.required.push("http://localhost/dacsn/userfiles/modules/microweber/api/content.js");
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/base64.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/checkbox.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/colorpicker.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/common-extend.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/common.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/dialog.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/domhelpers.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/dropdown.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/editor.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/element.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/elementedit.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/external.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/extradata-form.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/fullscreen.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/gallery.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/helpers.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/iframe-tools.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/images.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/jquery.tools.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/loading.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/loops.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/modules-dialogs.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/native-notification.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/notification.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/objects.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/responsive.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/select.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/spinner.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/storage.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/system-dialogs.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/tabs.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/tooltip.js');
...
mw.required.push('http://localhost/dacsn/userfiles/modules/microweber/api/tools/uiaccordion.js');
